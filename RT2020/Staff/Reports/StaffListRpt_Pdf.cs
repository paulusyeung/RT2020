...
namespace RT2020.Staff.Reports
{
    public partial class StaffListRpt_Pdf : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void StaffListRpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            this.txtDateCreate.DataBindings.Add("Text", DataSource, "CreatedOn", "{0:" + DateTimeHelper.GetDateTimeFormat() + "}");
            this.txtDatelChg.DataBindings.Add("Text", DataSource, "ModifiedOn", "{0:" + DateTimeHelper.GetDateTimeFormat() + "}");
            ...
            this.txtBirthday.DataBindings.Add("Text", DataSource, "Birthdate", "{0:" + DateTimeHelper.GetDateFormat() + "}");
