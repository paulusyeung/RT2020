...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="WC:Tags.ComboBox[@Attr.CustomStyle='Appendix1ComboBoxSkin']" mode="modContent">
  ...
  <xsl:template match="Tags.Options[../@Attr.CustomStyle='Appendix1ComboBoxSkin']" >
    <xsl:param name="prmIsEnabled">
  ...
  <xsl:template match="Tags.Options[../@Attr.CustomStyle='Appendix1ComboBoxSkin']" mode="modFrameCenterContent">
    <xsl:param name="prmIsEnabled" />
  ...
  <xsl:template match="WC:Tags.ComboBox[@Attr.CustomStyle='Appendix1ComboBoxSkin']" mode="modApplyAttributes">
