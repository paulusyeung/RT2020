...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="WC:Tags.ComboBox[@Attr.CustomStyle='Appendix2ComboBoxSkin']" mode="modContent">
  ...
  <xsl:template match="Tags.Options[../@Attr.CustomStyle='Appendix2ComboBoxSkin']" >
    <xsl:param name="prmIsEnabled">
  ...
  <xsl:template match="Tags.Options[../@Attr.CustomStyle='Appendix2ComboBoxSkin']" mode="modFrameCenterContent">
    <xsl:param name="prmIsEnabled" />
  ...
  <xsl:template match="WC:Tags.ComboBox[@Attr.CustomStyle='Appendix2ComboBoxSkin']" mode="modApplyAttributes">
