...
namespace RT2020.Product
{
    public class ProductToolbar
    {
        ...
        private void AddItemToToolBar(ToolBar tbProducts)
        {
            ...
            ddlReports.MenuItems.Add(new MenuItem(RT2020.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX1") + " List", string.Empty, "Appendix1 List"));
            ddlReports.MenuItems.Add(new MenuItem(RT2020.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX2") + " List", string.Empty, "Appendix2 List"));
            ddlReports.MenuItems.Add(new MenuItem(RT2020.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX3") + " List", string.Empty, "Appendix3 List"));
            ddlReports.MenuItems.Add(new MenuItem("-"));
            ddlReports.MenuItems.Add(new MenuItem(RT2020.SystemInfo.Settings.GetSystemLabelByKey("CLASS1") + " List", string.Empty, "Class1 List"));
            ddlReports.MenuItems.Add(new MenuItem(RT2020.SystemInfo.Settings.GetSystemLabelByKey("CLASS2") + " List", string.Empty, "Class2 List"));
            ddlReports.MenuItems.Add(new MenuItem(RT2020.SystemInfo.Settings.GetSystemLabelByKey("CLASS3") + " List", string.Empty, "Class3 List"));
            ddlReports.MenuItems.Add(new MenuItem(RT2020.SystemInfo.Settings.GetSystemLabelByKey("CLASS4") + " List", string.Empty, "Class4 List"));
            ddlReports.MenuItems.Add(new MenuItem(RT2020.SystemInfo.Settings.GetSystemLabelByKey("CLASS5") + " List", string.Empty, "Class5 List"));
            ddlReports.MenuItems.Add(new MenuItem(RT2020.SystemInfo.Settings.GetSystemLabelByKey("CLASS6") + " List", string.Empty, "Class6 List"));
            ddlReports.MenuItems.Add(new MenuItem("-"));
            ...
            ddlReports.MenuItems.Add(new MenuItem("-"));
            ddlReports.MenuItems.Add(new MenuItem(RT2020.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX1") + " ComBin List", string.Empty, "A1ComBin List"));
            ddlReports.MenuItems.Add(new MenuItem(RT2020.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX2") + " ComBin List", string.Empty, "A2ComBin List"));
            ddlReports.MenuItems.Add(new MenuItem(RT2020.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX3") + " ComBin List", string.Empty, "A3ComBin List"));
