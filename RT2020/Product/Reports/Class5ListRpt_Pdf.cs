...
{
    public partial class Class5ListRpt_Pdf : DevExpress.XtraReports.UI.XtraReport
    {
        private string _frmCode = string.Empty;
        private string _toCode = string.Empty;

        public Class5ListRpt_Pdf()
        {
            InitializeComponent();

            this.lblCaption.Text = RT2020.SystemInfo.Settings.GetSystemLabelByKey("CLASS5") + " List";
        }
    
        private void CategoryListRpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            this.txtFm.Text = _frmCode;
            this.txtTo.Text = _toCode;
            this.txtID.DataBindings.Add("Text", DataSource, "Class5Code");
            this.txtDESC.DataBindings.Add("Text", DataSource, "Class5Initial");
            this.txtDESC_LONG.DataBindings.Add("Text", DataSource, "Class5Name");
