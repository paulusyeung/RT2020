...
{
    public partial class Class5ListRpt_Xls : DevExpress.XtraReports.UI.XtraReport
    {
        private string _frmCode = string.Empty;
        private string _toCode = string.Empty;

        public Class5ListRpt_Xls()
        {
            InitializeComponent();
        ...
        private void CategoryListRptc_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            this.hdrFm1.Text = _frmCode;
            this.hdrTo1.Text = _toCode;
            this.ID1.DataBindings.Add("Text", DataSource, "Class5Code");
            this.DESC1.DataBindings.Add("Text", DataSource, "Class5Initial");
            this.DESCLONG1.DataBindings.Add("Text", DataSource, "Class5Name");
