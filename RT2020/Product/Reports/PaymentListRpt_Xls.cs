...
{
    public partial class PaymentListRpt_Xls : DevExpress.XtraReports.UI.XtraReport
    {
        private string _frmCode = string.Empty;
        private string _toCode = string.Empty;

        public PaymentListRpt_Xls()
        {
            InitializeComponent();
        }

        private void PayMentListRptc_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            this.hdrFm1.Text = _frmCode;
            this.hdrTo1.Text = _toCode;
           
            this.DESC1.DataBindings.Add("Text", DataSource, "TypeName");
