...
{
    public partial class Appendix1ListRpt_Pdf : DevExpress.XtraReports.UI.XtraReport
    {
        private string _frmCode = string.Empty;
        private string _toCode = string.Empty;

        public Appendix1ListRpt_Pdf()
        {
            InitializeComponent();

            this.lblCaption.Text = RT2020.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX1") + " List";
        }

        private void SeasonListRpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            this.txtFm.Text = _frmCode;
            this.txtTo.Text = _toCode;
            this.txtID.DataBindings.Add("Text", DataSource, "Appendix1Code");
            this.txtDESC.DataBindings.Add("Text", DataSource, "Appendix1Initial");
            this.txtDESC_LONG.DataBindings.Add("Text", DataSource, "Appendix1Name");
