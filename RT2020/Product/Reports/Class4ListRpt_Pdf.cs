...
{
    public partial class Class4ListRpt_Pdf : DevExpress.XtraReports.UI.XtraReport
    {
        private string _frmCode = string.Empty;
        private string _toCode = string.Empty;

        public Class4ListRpt_Pdf()
        {
            InitializeComponent();

            this.lblCaption.Text = RT2020.SystemInfo.Settings.GetSystemLabelByKey("CLASS4") + " List";
        }
      
        private void GroupListRpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            this.txtFm.Text = _frmCode;
            this.txtTo.Text = _toCode;
            this.txtID.DataBindings.Add("Text", DataSource, "Class4Code");
            this.txtDESC.DataBindings.Add("Text", DataSource, "Class4Initial");
            this.txtDESC_LONG.DataBindings.Add("Text", DataSource, "Class4Name");
