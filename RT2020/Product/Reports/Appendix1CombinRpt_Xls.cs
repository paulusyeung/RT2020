...
namespace RT2020.Product.Reports
{
    ...
    public partial class Appendix1CombinRpt_Xls : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public Appendix1CombinRpt_Xls()
        {
            ...
            this.lblCaption.Text = RT2020.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX1") + " Combin List";
            this.lblAppendix1.Text = RT2020.SystemInfo.Settings.GetSystemLabelByKey("APPENDIX1") + " Combin#";
        }
