...
namespace RT2020.NavPane
{
    public partial class SettingsNav : UserControl
    {
        public SettingsNav()
        {
            ...
            navSettings.DoubleClick += navSettings_DoubleClick;
        }

        private void navSettings_DoubleClick(object sender, EventArgs e)
        {
            LoadModule();
        }
        ...
        private void LoadModule()
        {
            ...
            {
                var menuTag = (MenuHelper.MenuTag)navSettings.SelectedNode.Tag;
