...
namespace RT2020.ModelEx
{
    public class ProductClass6Ex
    {
        ...
        /// <summary>
        /// Get a EF6.ProductClass6 object from the database using the given Class6Id
        /// </summary>
        /// <param name="class6Id">The primary key value</param>
        /// <returns>A EF6.ProductClass6 object</returns>
        public static EF6.ProductClass6 Get(Guid class6Id)
        {
            EF6.ProductClass6 result = null;

            using (var ctx = new EF6.RT2020Entities())
            {
                result = ctx.ProductClass6.Where(x => x.Class6Id == class6Id).AsNoTracking().FirstOrDefault();
            }
        ...
        /// <summary>
        /// Get a EF6.ProductClass6 object from the database using the given QueryString
        /// </summary>
        /// <param name="class6Id">The primary key value</param>
        /// <returns>A EF6.ProductClass6 object</returns>
        public static EF6.ProductClass6 Get(string whereClause)
        {
            EF6.ProductClass6 result = null;

            using (var ctx = new EF6.RT2020Entities())
            {
                result = ctx.ProductClass6
                    .SqlQuery(string.Format("Select * from ProductClass6 Where {0}", whereClause))
                    .AsNoTracking()
                    .FirstOrDefault();
            }
        ...
        /// <summary>
        /// Get a list of ProductClass6 objects from the database
        /// </summary>
        /// <returns>A list containing all of the ProductClass6 objects in the database.</returns>
        public static List<EF6.ProductClass6> GetList()
        {
            var whereClause = "1 = 1";
        ...
        /// </summary>
        /// <returns>A list containing all of the ProductClass6 objects in the database ordered by the columns specified.</returns>
        public static List<EF6.ProductClass6> GetList(string whereClause)
        {
            var orderBy = new string[] { "Class6Id" };
        ...
        /// </summary>
        /// <returns>A list containing all of the ProductClass6 objects in the database.</returns>
        public static List<EF6.ProductClass6> GetList(string whereClause, string[] orderBy)
        {
            List<EF6.ProductClass6> result = new List<EF6.ProductClass6>();
            ...
            {
                result = ctx.ProductClass6
                    .SqlQuery(string.Format("Select * from ProductClass6 Where {0} Order By {1}", whereClause, orderby))
                    .AsNoTracking()
                    .ToList();
            }
        ...
        /// <summary>
        /// Deletes a EF6.ProductClass6 object from the database.
        /// </summary>
        /// <param name="class6Id">The primary key value</param>
        public static bool Delete(Guid class6Id)
        {
            bool result = false;

            using (var ctx = new EF6.RT2020Entities())
            {
                var item = ctx.ProductClass6.Find(class6Id);
                if (item != null)
                {
                    if (item.Retired)
                    {
                        ctx.ProductClass6.Remove(item);
                    }
                    else
                    {
                        item.Retired = true;
		...
		public static void LoadCombo(ref ComboBox ddList, string TextField, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                ...
                var kvpList = ctx.Database.SqlQuery<ComboBoxHelper.ComboBoxItem>(
                    string.Format(
                        "Select Class6Id as [Key], {0} as [Value] from ProductClass6 Where {1} Order By {2}",
		...
		public static void LoadCombo(ref ComboBox ddList, string[] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string WhereClause, string[] OrderBy)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                ...
                foreach (var item in list)
                {
                    ...
                    data.Add(new KeyValuePair<Guid, string>(item.Class6Id, text));
                }
        ...
        private static string GetFormatedText(EF6.ProductClass6 target, string[] textField, string textFormatString)
        {
            for (int i = 0; i < textField.Length; i++)
            {
