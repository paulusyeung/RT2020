...
namespace RT2020.ModelEx
{
    public class CurrencyEx
    {
        ...
        /// <summary>
        /// Get a list of Currency objects from the database
        /// </summary>
        /// <returns>A list containing all of the Currency objects in the database.</returns>
        public static List<EF6.Currency> GetList()
        {
            var whereClause = "1 = 1";
        ...
        /// </summary>
        /// <returns>A list containing all of the Currency objects in the database ordered by the columns specified.</returns>
        public static List<EF6.Currency> GetList(string whereClause)
        {
            var orderBy = new string[] { "CurrencyId" };
        ...
        /// </summary>
        /// <returns>A list containing all of the Currency objects in the database.</returns>
        public static List<EF6.Currency> GetList(string whereClause, string[] orderBy)
        {
            List<EF6.Currency> result = new List<EF6.Currency>();
            ...
            {
                result = ctx.Currency
                    .SqlQuery(string.Format("Select * from Currency Where {0} Order By {1}", whereClause, orderby))
                    .AsNoTracking()
                    .ToList();
            }
        ...
        /// <summary>
        /// Deletes a EF6.Currency object from the database.
        /// </summary>
        /// <param name="currencyId">The primary key value</param>
        public static bool Delete(Guid currencyId)
        {
            bool result = false;

            using (var ctx = new EF6.RT2020Entities())
            {
                var item = ctx.Currency.Find(currencyId);
                if (item != null)
                {
                    ctx.Currency.Remove(item);
                    ctx.SaveChanges();
                    result = true;
                }
            }
		...
		public static void LoadCombo(ref ComboBox ddList, string TextField, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                ...
                var kvpList = ctx.Database.SqlQuery<ComboBoxHelper.ComboBoxItem>(
                    string.Format(
                        "Select CurrencyId as [Key], {0} as [Value] from Currency Where {1} Order By {2}",
		...
		public static void LoadCombo(ref ComboBox ddList, string[] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string WhereClause, string[] OrderBy)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                ...
                foreach (var item in list)
                {
                    ...
                    data.Add(new KeyValuePair<Guid, string>(item.CurrencyId, text));
                }
