...
namespace RT2020.ModelEx
{
    public class SupplierAddressTypeEx
    {
        ...
        /// <summary>
        /// Get a EF6.SupplierAddressType object from the database using the given AddressTypeId
        /// </summary>
        /// <param name="addressTypeId">The primary key value</param>
        /// <returns>A EF6.SupplierAddressType object</returns>
        public static EF6.SupplierAddressType Get(Guid addressTypeId)
        {
            EF6.SupplierAddressType result = null;

            using (var ctx = new EF6.RT2020Entities())
            {
                result = ctx.SupplierAddressType.Where(x => x.AddressTypeId == addressTypeId).AsNoTracking().FirstOrDefault();
            }
        ...
        /// <summary>
        /// Get a EF6.SupplierAddressType object from the database using the given QueryString
        /// </summary>
        /// <param name="addressTypeId">The primary key value</param>
        /// <returns>A EF6.SupplierAddressType object</returns>
        public static EF6.SupplierAddressType Get(string whereClause)
        {
            EF6.SupplierAddressType result = null;

            using (var ctx = new EF6.RT2020Entities())
            {
                result = ctx.SupplierAddressType
                    .SqlQuery(string.Format("Select * from SupplierAddressType Where {0}", whereClause))
                    .AsNoTracking()
                    .FirstOrDefault();
            }
        ...
        /// <summary>
        /// Get a list of SupplierAddressType objects from the database
        /// </summary>
        /// <returns>A list containing all of the SupplierAddressType objects in the database.</returns>
        public static List<EF6.SupplierAddressType> GetList()
        {
            var whereClause = "1 = 1";
        ...
        /// </summary>
        /// <returns>A list containing all of the SupplierAddressType objects in the database ordered by the columns specified.</returns>
        public static List<EF6.SupplierAddressType> GetList(string whereClause)
        {
        ...
        /// </summary>
        /// <returns>A list containing all of the SupplierAddressType objects in the database.</returns>
        public static List<EF6.SupplierAddressType> GetList(string whereClause, string[] orderBy)
        {
            List<EF6.SupplierAddressType> result = new List<EF6.SupplierAddressType>();
            ...
            {
                result = ctx.SupplierAddressType
                    .SqlQuery(string.Format("Select * from SupplierAddressType Where {0} Order By {1}", whereClause, orderby))
                    .AsNoTracking()
                    .ToList();
            }
        ...
        /// <summary>
        /// Deletes a EF6.SupplierAddressType object from the database.
        /// </summary>
        /// <param name="addressTypeId">The primary key value</param>
        public static bool Delete(Guid addressTypeId)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                var item = ctx.SupplierAddressType.Find(addressTypeId);
                if (item != null)
                {
		...
		public static void LoadCombo(ref ComboBox ddList, string TextField, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                ...
                var kvpList = ctx.Database.SqlQuery<ComboBoxHelper.ComboBoxItem>(
                    string.Format(
                        "Select AddressTypeId as [Key], {0} as [Value] from SupplierAddressType Where {1} Order By {2}",
		...
		public static void LoadCombo(ref ComboBox ddList, string[] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string WhereClause, string[] OrderBy)
        {
            ...
            if (SwitchLocale && TextField.Length > 0)
            {
                ...
                {
                    if (TextField[i] == "AddressTypeName")
                    {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                var list = ctx.SupplierAddressType.SqlQuery(
                    String.Format(
                        "Select * from SupplierAddressType Where {0} Order By {1}",
        ...
        private static string GetFormatedText(EF6.SupplierAddressType target, string[] textField, string textFormatString)
        {
            for (int i = 0; i < textField.Length; i++)
            {
