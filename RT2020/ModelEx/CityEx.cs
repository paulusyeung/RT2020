...
namespace RT2020.ModelEx
{
    public class CityEx
    {
        ...
        /// <summary>
        /// Get a list of City objects from the database
        /// </summary>
        /// <returns>A list containing all of the City objects in the database.</returns>
        public static List<EF6.City> GetList()
        {
            var whereClause = "1 = 1";
        ...
        /// </summary>
        /// <returns>A list containing all of the City objects in the database ordered by the columns specified.</returns>
        public static List<EF6.City> GetList(string whereClause)
        {
            var orderBy = new string[] { "CityId" };
        ...
        /// </summary>
        /// <returns>A list containing all of the City objects in the database.</returns>
        public static List<EF6.City> GetList(string whereClause, string[] orderBy)
        {
            List<EF6.City> result = new List<EF6.City>();
            ...
            {
                result = ctx.City
                    .SqlQuery(string.Format("Select * from City Where {0} Order By {1}", whereClause, orderby))
                    .AsNoTracking()
                    .ToList();
            }
        ...
        /// <summary>
        /// Deletes a EF6.City object from the database.
        /// </summary>
        /// <param name="cityId">The primary key value</param>
        public static bool Delete(Guid cityId)
        {
            bool result = false;

            using (var ctx = new EF6.RT2020Entities())
            {
                var item = ctx.City.Find(cityId);
                if (item != null)
                {
                    ctx.City.Remove(item);
                    ctx.SaveChanges();
                    result = true;
                }
            }
		...
		public static void LoadCombo(ref ComboBox ddList, string TextField, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                ...
                var kvpList = ctx.Database.SqlQuery<ComboBoxHelper.ComboBoxItem>(
                    string.Format(
                        "Select CityId as [Key], {0} as [Value] from City Where {1} Order By {2}",
		...
		public static void LoadCombo(ref ComboBox ddList, string[] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string WhereClause, string[] OrderBy)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                ...
                foreach (var item in list)
                {
                    ...
                    data.Add(new KeyValuePair<Guid, string>(item.CityId, text));
                }
