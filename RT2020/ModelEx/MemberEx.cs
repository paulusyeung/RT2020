...
{
    /// <summary>
    /// This extension provides access to the EF6 entity dbo.Member.
    /// Date Created:   2020-12-16 06:11:29
    ...
    public class MemberEx
    {
        public static Guid GetIdBySql(string whereClause)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                var item = ctx.Member
                    ...
                    .AsNoTracking()
                    .FirstOrDefault();
                if (item != null) result = item.MemberId;
            }
        ...
        /// <summary>
        /// Get a EF6.Member object from the database using the given MemberId
        /// </summary>
        /// <param name="memberId">The primary key value</param>
        /// <returns>A EF6.Member object</returns>
        public static EF6.Member Get(Guid memberId)
        {
            EF6.Member result = null;

            using (var ctx = new EF6.RT2020Entities())
            {
                result = ctx.Member.Where(x => x.MemberId == memberId).AsNoTracking().FirstOrDefault();
            }
        ...
        /// <summary>
        /// Get a EF6.Member object from the database using the given QueryString
        /// </summary>
        /// <param name="memberId">The primary key value</param>
        /// <returns>A EF6.Member object</returns>
        public static EF6.Member Get(string whereClause)
        {
            EF6.Member result = null;
        ...
        /// <summary>
        /// Get a list of Member objects from the database
        /// </summary>
        /// <returns>A list containing all of the Member objects in the database.</returns>
        public static List<EF6.Member> GetList()
        {
            var whereClause = "1 = 1";
        ...
        /// </summary>
        /// <returns>A list containing all of the Member objects in the database ordered by the columns specified.</returns>
        public static List<EF6.Member> GetList(string whereClause)
        {
            var orderBy = new string[] { "MemberId" };
        ...
        /// </summary>
        /// <returns>A list containing all of the Member objects in the database.</returns>
        public static List<EF6.Member> GetList(string whereClause, string[] orderBy)
        {
            List<EF6.Member> result = new List<EF6.Member>();
            ...
            {
                result = ctx.Member
                    .SqlQuery(string.Format("Select * from Member Where {0} Order By {1}", whereClause, orderby))
                    .AsNoTracking()
                    .ToList();
            }
        ...
        /// <summary>
        /// Deletes a EF6.Member object from the database.
        /// </summary>
        /// <param name="memberId">The primary key value</param>
        public static bool Delete(Guid memberId)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                var item = ctx.Member.Find(memberId);
                if (item != null)
                {
                    ctx.Member.Remove(item);
                    ctx.SaveChanges();
                    result = true;
                }
            }
		...
		public static void LoadCombo(ref ComboBox ddList, string TextField, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                var list = ctx.Member.SqlQuery(
                    String.Format(
                        "Select * from Member Where {0} Order By {1}",
        ...
        private static string GetFormatedText(EF6.Member target, string[] textField, string textFormatString)
        {
            for (int i = 0; i < textField.Length; i++)
            {
