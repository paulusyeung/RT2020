...
{
    /// <summary>
    /// This extension provides access to the EF6 entity dbo.SmartTag4Member_Options.
    /// Date Created:   2020-12-27 05:30:33
    /// Created By:     Generated by CodeSmith version 7.0.0.15123
    /// Template:       BusinessObjects_v2020.12.12.cst
    /// </summary>
    public class SmartTag4Member_OptionsEx
    {
        public static bool IsTagCodeInUse(Guid tagId, string code)
        {
            ...
            {
                var tag = ctx.SmartTag4Member_Options.Where(x => x.TagId == tagId && x.OptionCode == code).FirstOrDefault();
        ...
        {
            var tag11 = SmartTag4MemberEx.GetIdByPriority(tagNumber);
        ...
        /// <summary>
        /// Get a list of SmartTag4Member_Options objects from the database
        /// </summary>
        /// <returns>A list containing all of the SmartTag4Member_Options objects in the database.</returns>
        public static List<EF6.SmartTag4Member_Options> GetList()
        {
            var whereClause = "1 = 1";
        ...
        /// </summary>
        /// <returns>A list containing all of the SmartTag4Member_Options objects in the database ordered by the columns specified.</returns>
        public static List<EF6.SmartTag4Member_Options> GetList(string whereClause)
        {
        ...
        /// </summary>
        /// <returns>A list containing all of the SmartTag4Member_Options objects in the database.</returns>
        public static List<EF6.SmartTag4Member_Options> GetList(string whereClause, string[] orderBy)
        {
            List<EF6.SmartTag4Member_Options> result = new List<EF6.SmartTag4Member_Options>();
            ...
            {
                result = ctx.SmartTag4Member_Options
                    .SqlQuery(string.Format("Select * from SmartTag4Member_Options Where {0} Order By {1}", whereClause, orderby))
                    .AsNoTracking()
                    .ToList();
            }
        ...
        /// <summary>
        /// Deletes a EF6.SmartTag4Member_Options object from the database.
        /// </summary>
        /// <param name="optionId">The primary key value</param>
        public static bool Delete(Guid optionId)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                var item = ctx.SmartTag4Member_Options.Find(optionId);
                if (item != null)
                {
		...
		public static void LoadCombo(ref ComboBox ddList, string TextField, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                ...
                var kvpList = ctx.Database.SqlQuery<ComboBoxHelper.ComboBoxItem>(
                    string.Format(
                        "Select OptionId as [Key], {0} as [Value] from SmartTag4Member_Options Where {1} Order By {2}",
		...
		public static void LoadCombo(ref ComboBox ddList, string[] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string WhereClause, string[] OrderBy)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                var list = ctx.SmartTag4Member_Options.SqlQuery(
                    String.Format(
                        "Select * from SmartTag4Member_Options Where {0} Order By {1}",
