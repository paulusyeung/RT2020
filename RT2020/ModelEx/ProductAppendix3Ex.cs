        ...
        //{
            ...
            using (var ctx = new RT2020.EF6.RT2020Entities())
            {
                var list = ctx.ProductAppendix3.SqlQuery(
                    String.Format(
                        "Select * from ProductApendix3 Where {0} Order By {1}",
                ...
                if (BlankLine)
                {
                    list.Insert(0, new EF6.ProductAppendix3()
                    {
                        Appendix3Id = Guid.Empty,
                        Appendix3Code = "",
                        Appendix3Name = BlankLineText,
                        Appendix3Name_Chs = BlankLineText,
                        Appendix3Name_Cht = BlankLineText,
                    });
                }
                #endregion

                ddList.DataSource = list;
                ddList.ValueMember = "Apendix3Id";
