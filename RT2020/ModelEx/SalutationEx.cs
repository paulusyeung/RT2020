    ...
    public class SalutationEx
    {
        ...
        //{
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                ...
                if (BlankLine)
                {
                    list.Insert(0, new EF6.Salutation()
                    {
                        SalutationId = Guid.Empty,
                        SalutationCode = "",
                        SalutationName = BlankLineText,
                        SalutationName_Chs = BlankLineText,
                        SalutationName_Cht = BlankLineText,
                    });
                }
                #endregion

                ddList.DataSource = list;
                ddList.ValueMember = "SalutationId";
