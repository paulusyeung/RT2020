...
{
    public partial class RptVipMLblYtdForm : Form
    {
        public RptVipMLblYtdForm()
        {
            InitializeComponent();
        }
...
WHERE VipNumber BETWEEN '" + from + @"' AND '" + to + @"'
 ...
 ORDER BY [Date Commence]";
        ...
        private void RptVipMLblYtdForm_Load(object sender, EventArgs e)
        {
            FillPositionList(14);
        }
        ...
        private void btnPriview_Click(object sender, EventArgs e)
        {
            ...
            {
                view.ReportName = "RT2020.Member.Reports.VipMLblYtdForm_002ADCRdl.rdlc";
            }
            else
            {
                view.ReportName = "RT2020.Member.Reports.VipMLblYtdForm_002CDARdl.rdlc";
            }
            #endregion
