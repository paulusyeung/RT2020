...
{
    public partial class SmartTag4MemberWizard : Form
    {
        #region private Properties
        private Guid _SmartTagId = Guid.Empty;
        #endregion

        public SmartTag4MemberWizard()
        {
            InitializeComponent();
        }
        ...
        {
            this.Text = WestwindHelper.GetWord("smartTag4Member.setup", "Model");

            colLN.Text = WestwindHelper.GetWord("listview.line", "Tools");

            //colParentDept.Text = WestwindHelper.GetWord("department.parent", "Model");
            colTagCode.Text = WestwindHelper.GetWord("smartTag4Member.code", "Model");
            colPriority.Text = WestwindHelper.GetWord("smartTag4Member.priority", "Model");
            colTagName.Text = WestwindHelper.GetWord("smartTag4Member.name", "Model");
            ...
            lblTagCode.Text = WestwindHelper.GetWordWithColon("smartTag4Member.code", "Model");
            lblTagName.Text = WestwindHelper.GetWordWithColon("smartTag4Member.name", "Model");
            ...
            lblPriority.Text = WestwindHelper.GetWordWithColon("smartTag4Member.priority", "Model");
        ...
        private void BindTagList()
        {
            ...
            {
                var list = ctx.SmartTag4Member.OrderBy(x => x.Priority).AsNoTracking().ToList();
        ...
        private bool IsValid()
        {
            ...
            errorProvider.SetError(txtTagCode, string.Empty);
            if (_SmartTagId == Guid.Empty && ModelEx.SmartTag4MemberEx.IsTagCodeInUse(txtTagCode.Text.Trim()))
            {
        ...
        private void Delete()
        {
            var result = ModelEx.SmartTag4MemberEx.DeleteOptionsToo(_SmartTagId);
