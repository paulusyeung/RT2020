...
namespace RT2020.Helper
{
    ...
    public class MacaoHelper
    {
        ...
        public static CountryStateCityItem Macao
        {
            get
            {
                return new CountryStateCityItem { Parent = "", Id = "MO", Name = "Macao SAR", NameAlt1 = "中国澳门特别行政区", NameAlt2 = "中國澳門特別行政區" };
            }
        }
        ...
        private static List<CountryStateCityItem> Region
        {
            get
            {
                ...
                result.Add(new CountryStateCityItem { Parent = "MO", Id = "R1", Name = "Macau Island", NameAlt1 = "澳门半岛", NameAlt2 = "澳門半島" });
                result.Add(new CountryStateCityItem { Parent = "MO", Id = "R2", Name = "Taipa", NameAlt1 = "氹仔", NameAlt2 = "氹仔" });
                result.Add(new CountryStateCityItem { Parent = "MO", Id = "R3", Name = "Cotai", NameAlt1 = "路氹城", NameAlt2 = "路氹城" });
                result.Add(new CountryStateCityItem { Parent = "MO", Id = "R4", Name = "Coloane", NameAlt1 = "路环", NameAlt2 = "路環" });
