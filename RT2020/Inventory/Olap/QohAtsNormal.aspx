<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QohAtsNormal.aspx.cs" Inherits="RT2020.Inventory.Olap.QohAtsNormal" %>
...
<body style="margin: 0">
    ...
    <div style="font: 8pt Tahoma; border-right: 0; border-top: 0; border-left: 0; padding: 0px 0px 0px 0px;" runat="server" id="divPivotGrid">
        ...
        <asp:SqlDataSource ID="olapSQLSource" runat="server" 
            ...
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="chkShowRtlAmt" Name="ShowRetailAmount" 
                    PropertyName="Checked" Type="Boolean" />
                <asp:ControlParameter ControlID="chkShowRemarks" Name="ShowRemarks1To6" 
                    PropertyName="Checked" Type="Boolean" />
