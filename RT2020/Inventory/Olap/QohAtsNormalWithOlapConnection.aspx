<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QohAtsNormalWithOlapConnection.aspx.cs"
    Inherits="RT2020.Inventory.Olap.QohAtsNormalWithOlapConnection" AspCompat="true" %>
...
<body style="margin: 0">
    ...
    <div runat="server" id="divOptions">
        ...
        <div style="background-color: transparent; font: 10pt Tahoma; border-right: 0; border-top: 0;
            ...
            <asp:TextBox runat="server" ID="txtDateTo" Enabled="false" Width="80px" />
        </div>
        <div style="background-color: transparent; font: 10pt Tahoma; border-right: 0; border-top: 0;
            border-left: 0; padding: 6px 10px 6px 10px;">
    ...
    <div style="font: 10pt Tahoma; border-right: 0; border-top: 0; border-left: 0; padding: 0px 0px 0px 0px;" runat="server" id="divPivotGrid">
        ...
        <dxwpg:ASPxPivotGrid ID="olapQohAtsNormal" runat="server" CustomizationFieldsLeft="600"
            CustomizationFieldsTop="400"
            OLAPConnectionString="Provider=msolap;Data Source=.\SQL2K8;Initial Catalog=RT2020AS;Cube Name=QohAts;" 
            onprerender="olapQohAtsNormal_PreRender">
