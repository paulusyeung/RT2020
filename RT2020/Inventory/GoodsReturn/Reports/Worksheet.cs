...
namespace RT2020.Inventory.GoodsReturn.Reports
{
    ...
    public partial class WorksheetWizard : Form
    {
        ...
        private void FillFromList()
        {
            ...
            string sql = "TxType = '" + Common.Enums.TxType.REJ.ToString() + "'";
        ...
        //    rdlExport.ReportName = "RT2020.Inventory.GoodsReturn.Reports.WorksheetRdl.rdlc";
        //    rdlExport.ReportDatasourceName = "RT2020_Controls_Reporting_DataSource_vwRptBatchCAP";
