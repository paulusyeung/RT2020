...
WHERE (STKCODE >= '" + txtFromStockCode.Text.Trim() + "') AND (STKCODE <= '" + txtToStockCode.Text.Trim() + @"') AND 
        ...
        TxType ='" + Common.Enums.TxType.REJ + "' AND LocationCode = '" + Shop + "'";
        ...
        //    string fileName = "REJJournalList_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".txt";
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            if (IsSelValid())
            {
                ...
                view.ReportName = "RT2020.Inventory.GoodsReturn.Reports.JournalRdl.rdlc";
