        ...
        private void btnPriview_Click(object sender, EventArgs e)
        {
            if (IsSelValid())
            {
                ...
                if (ReportDataSourceName() == "vwRptStockStatus_StockValue")
                {
                    ...
                    {
                        view.ReportName = "RT2020.Inventory.Reports.StockStatus.StockStatus_StockValueWithClassRdl.rdlc";
                    }
                    else if (this.cboStkRemark.Text.Trim() == "Description")
                    {
                        view.ReportName = "RT2020.Inventory.Reports.StockStatus.StockStatus_StockValueWithDescRdl.rdlc";
                    }
                }
                else
                {
                    if (this.cboStkRemark.Text.Trim() == "Class 1 - 6")
                    {
                        view.ReportName = "RT2020.Inventory.Reports.StockStatus.StockStatus_StockValuePeriodWithClassRdl.rdlc";
                    }
                    else if (this.cboStkRemark.Text.Trim() == "Description")
                    {
                        view.ReportName = "RT2020.Inventory.Reports.StockStatus.StockStatus_StockValuePeriodWithDescRdl.rdlc";
                    }
                }
                #endregion
