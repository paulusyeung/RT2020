...
namespace RT2020.Inventory.Replenishment.Reports
{
    ...
    public partial class JournalWizard : Form
    {
        ...
        private DataTable BindData()
        {
            ...
            FLocation = this.cboLocation.Text.Trim();

            string TLocation = string.Empty;
            TLocation = this.cboVsLocation.Text.Trim();

            string sql = @"
            SELECT * FROM dbo.vwJournalRPLList WHERE (STKCODE >= '" + txtFromStockCode.Text.Trim() + "') AND (STKCODE <= '" + txtToStockCode.Text.Trim() + @"')
            ...
            sql = sql + " ORDER BY STKCODE, TxNumber";
        ...
        private void btnPriview_Click(object sender, EventArgs e)
        {
            if (IsSelValid())
            {
                ...
                view.ReportDatasourceName = "RT2020_Controls_Reporting_DataSource_vwJournalRPLList";
                view.ReportName = "RT2020.Inventory.Replenishment.Reports.JournalRdl.rdlc";
        ...
        private int ForMonth
        {
            get
            {
                return int.Parse(txtMonth.Text.Trim());
            }
        }
        ...
        private int ForYear
        {
            get
            {
                return int.Parse(txtYear.Text.Trim());
            }
        }
        #endregion
    }
