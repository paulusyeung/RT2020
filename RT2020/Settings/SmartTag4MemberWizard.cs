...
namespace RT2020.Settings
{
    public partial class SmartTag4MemberWizard : Form
    {
        ...
        private void BindTagList()
        {
            ...
            sql.Append(" FROM SmartTag4Member ");
            ...
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader(cmd))
            {
                while (reader.Read())
                {
                    ...
                    objItem.SubItems.Add(reader.GetString(3)); // SmartTag4Member Name
                    objItem.SubItems.Add(reader.GetString(4)); // SmartTag4Member Name Chs
                    objItem.SubItems.Add(reader.GetString(5)); // SmartTag4Member Name Cht
