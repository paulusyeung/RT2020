...
namespace RT2020.Common.ModelEx
{
    public class StaffJobTitleEx
    {
        public static Guid GetJobTitleIdByName(string name)
        {
            ...
            {
                var p = ctx.StaffJobTitle.Where(x => x.JobTitleName == name).FirstOrDefault();
        ...
        public static bool IsJobTitleCodeInUse(string code)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                var jt = ctx.StaffJobTitle.Where(x => x.JobTitleCode == code).FirstOrDefault();
        ...
        /// <summary>
        /// Get a list of StaffJobTitle objects from the database
        /// </summary>
        /// <returns>A list containing all of the StaffJobTitle objects in the database.</returns>
        public static List<EF6.StaffJobTitle> GetList()
        {
            var whereClause = "1 = 1";
        ...
        /// </summary>
        /// <returns>A list containing all of the StaffJobTitle objects in the database ordered by the columns specified.</returns>
        public static List<EF6.StaffJobTitle> GetList(string whereClause)
        {
        ...
        /// </summary>
        /// <returns>A list containing all of the StaffJobTitle objects in the database.</returns>
        public static List<EF6.StaffJobTitle> GetList(string whereClause, string[] orderBy)
        {
            List<EF6.StaffJobTitle> result = new List<EF6.StaffJobTitle>();
            ...
            {
                result = ctx.StaffJobTitle
                    .SqlQuery(string.Format("Select * from StaffJobTitle Where {0} Order By {1}", whereClause, orderby))
                    .AsNoTracking()
                    .ToList();
            }
        ...
        /// <summary>
        /// Deletes a EF6.StaffJobTitle object from the database.
        /// </summary>
        /// <param name="jobTitleId">The primary key value</param>
        public static bool Delete(Guid jobTitleId)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                var item = ctx.StaffJobTitle.Find(jobTitleId);
                if (item != null)
                {
                    ctx.StaffJobTitle.Remove(item);
                    ctx.SaveChanges();
                    result = true;
                }
            }
		...
		public static void LoadCombo(ref ComboBox ddList, string TextField, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                ...
                var kvpList = ctx.Database.SqlQuery<ComboBoxHelper.ComboBoxItem>(
                    string.Format(
                        "Select JobTitleId as [Key], {0} as [Value] from StaffJobTitle Where {1} Order By {2}",
		...
		public static void LoadCombo(ref ComboBox ddList, string[] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string WhereClause, string[] OrderBy)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                var list = ctx.StaffJobTitle.SqlQuery(
                    String.Format(
                        "Select * from StaffJobTitle Where {0} Order By {1}",
