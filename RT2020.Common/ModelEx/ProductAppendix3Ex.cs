...
{
    public class ProductAppendix3Ex
    {
        public static bool IsAppendixCodeInUse(string code)
        {
            ...
            {
                var item = ctx.ProductAppendix3.Where(x => x.Appendix3Code == code).FirstOrDefault();
        ...
        public static Guid GetIdByCode(string code)
        {
            ...
            {
                var item = ctx.ProductAppendix3.Where(x => x.Appendix3Code == code).FirstOrDefault();
                if (item != null) result = item.Appendix3Id;
            }
        ...
        public static Guid GetIdByInitial(string initial)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                var item = ctx.ProductAppendix3.Where(x => x.Appendix3Initial == initial).FirstOrDefault();
                if (item != null) result = item.Appendix3Id;
            }
        ...
        /// <summary>
        /// Get a list of ProductAppendix3 objects from the database
        /// </summary>
        /// <returns>A list containing all of the ProductAppendix3 objects in the database.</returns>
        public static List<EF6.ProductAppendix3> GetList()
        {
            var whereClause = "1 = 1";
        ...
        /// </summary>
        /// <returns>A list containing all of the ProductAppendix3 objects in the database ordered by the columns specified.</returns>
        public static List<EF6.ProductAppendix3> GetList(string whereClause)
        {
            var orderBy = new string[] { "Appendix3Id" };
        ...
        /// </summary>
        /// <returns>A list containing all of the ProductAppendix3 objects in the database.</returns>
        public static List<EF6.ProductAppendix3> GetList(string whereClause, string[] orderBy)
        {
            List<EF6.ProductAppendix3> result = new List<EF6.ProductAppendix3>();
            ...
            {
                result = ctx.ProductAppendix3
                    .SqlQuery(string.Format("Select * from ProductAppendix3 Where {0} Order By {1}", whereClause, orderby))
                    .AsNoTracking()
                    .ToList();
            }
        ...
        /// <summary>
        /// Deletes a EF6.ProductAppendix3 object from the database.
        /// </summary>
        /// <param name="appendix3Id">The primary key value</param>
        public static bool Delete(Guid appendix3Id)
        {
            bool result = false;

            using (var ctx = new EF6.RT2020Entities())
            {
                var item = ctx.ProductAppendix3.Find(appendix3Id);
                if (item != null)
                {
                    ctx.ProductAppendix3.Remove(item);
                    ctx.SaveChanges();
                    result = true;
                }
            }
		...
		public static void LoadCombo(ref ComboBox ddList, string TextField, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
        {
            ...
            if (SwitchLocale)
            {
                ...
                {
                    if (OrderBy[i] == "Appendix3Name")
                    {
                        OrderBy[i] = CookieHelper.CurrentLocaleId == LanguageHelper.AlternateLanguage2.Key ?
                            "Appendix3Name_Cht" : CookieHelper.CurrentLocaleId == LanguageHelper.AlternateLanguage1.Key ?
                            "Appendix3Name_Chs" :
                            "Appendix3Name";
                    }
                }
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                ...
                var kvpList = ctx.Database.SqlQuery<ComboBoxHelper.ComboBoxItem>(
                    string.Format(
                        "Select Appendix3Id as [Key], {0} as [Value] from ProductAppendix3 Where {1} Order By {2}",
		...
		public static void LoadCombo(ref ComboBox ddList, string[] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string WhereClause, string[] OrderBy)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                var list = ctx.ProductAppendix3.SqlQuery(
                    String.Format(
                        "Select * from ProductAppendix3 Where {0} Order By {1}",
                ...
                foreach (var item in list)
                {
                    ...
                    data.Add(new KeyValuePair<Guid, string>(item.Appendix3Id, text));
                }
