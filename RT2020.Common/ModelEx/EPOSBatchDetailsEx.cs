...
{
    /// <summary>
    /// This extension provides access to the EF6 entity dbo.EPOSBatchDetails.
    /// Date Created:   2020-12-18 07:22:00
    /// Created By:     Generated by CodeSmith version 7.0.0.15123
    /// Template:       BusinessObjects_v2020.12.12.cst
    /// </summary>
    public class EPOSBatchDetailsEx
    {
        public static decimal GetTotalQty(Guid headerId)
        {
            ...
            {
                result = ctx.EPOSBatchDetails.Where(x => x.HeaderId == headerId).Sum(x => x.Qty.Value);
            }
        ...
        public static decimal GetTotalAmount(Guid headerId)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                var list = ctx.EPOSBatchDetails.Where(x => x.HeaderId == headerId);
        ...
        /// <summary>
        /// Get a list of EPOSBatchDetails objects from the database
        /// </summary>
        /// <returns>A list containing all of the EPOSBatchDetails objects in the database.</returns>
        public static List<EF6.EPOSBatchDetails> GetList()
        {
            var whereClause = "1 = 1";
        ...
        /// </summary>
        /// <returns>A list containing all of the EPOSBatchDetails objects in the database ordered by the columns specified.</returns>
        public static List<EF6.EPOSBatchDetails> GetList(string whereClause)
        {
        ...
        /// </summary>
        /// <returns>A list containing all of the EPOSBatchDetails objects in the database.</returns>
        public static List<EF6.EPOSBatchDetails> GetList(string whereClause, string[] orderBy)
        {
            List<EF6.EPOSBatchDetails> result = new List<EF6.EPOSBatchDetails>();
            ...
            {
                result = ctx.EPOSBatchDetails
                    .SqlQuery(string.Format("Select * from EPOSBatchDetails Where {0} Order By {1}", whereClause, orderby))
                    .AsNoTracking()
                    .ToList();
            }
        ...
        /// <summary>
        /// Deletes a EF6.EPOSBatchDetails object from the database.
        /// </summary>
        /// <param name="detailsId">The primary key value</param>
        public static bool Delete(Guid detailsId)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                var item = ctx.EPOSBatchDetails.Find(detailsId);
                if (item != null)
                {
                    ctx.EPOSBatchDetails.Remove(item);
                    ctx.SaveChanges();
                    result = true;
                }
            }
		...
		public static void LoadCombo(ref ComboBox ddList, string TextField, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                var list = ctx.EPOSBatchDetails.SqlQuery(
                    String.Format(
                        "Select * from EPOSBatchDetails Where {0} Order By {1}",
                ...
                if (BlankLine)
                {
                    list.Insert(0, new EF6.EPOSBatchDetails()
                    {
