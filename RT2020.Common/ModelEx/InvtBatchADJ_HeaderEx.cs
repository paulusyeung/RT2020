...
{
    /// <summary>
    /// This extension provides access to the EF6 entity dbo.InvtBatchADJ_Header.
    /// Date Created:   2020-12-18 03:18:24
    /// Created By:     Generated by CodeSmith version 7.0.0.15123
    /// Template:       BusinessObjects_v2020.12.12.cst
    /// </summary>
    public class InvtBatchADJ_HeaderEx
    {
        public static bool DeleteChildToo(Guid headerId)
        {
            ...
            {
                var oHeader = ctx.InvtBatchADJ_Header.Find(headerId);
                if (oHeader != null)
                {
                    var details = ctx.InvtBatchADJ_Details.Where(x => x.HeaderId == headerId);
                    foreach (var detail in details)
                    {
                        ctx.InvtBatchADJ_Details.Remove(detail);
                    }

                    ctx.InvtBatchADJ_Header.Remove(oHeader);
                    ctx.SaveChanges();
        ...
        /// <summary>
        /// Get a EF6.InvtBatchADJ_Header object from the database using the given HeaderId
        /// </summary>
        /// <param name="headerId">The primary key value</param>
        /// <returns>A EF6.InvtBatchADJ_Header object</returns>
        public static EF6.InvtBatchADJ_Header Get(Guid headerId)
        {
            EF6.InvtBatchADJ_Header result = null;

            using (var ctx = new EF6.RT2020Entities())
            {
                result = ctx.InvtBatchADJ_Header.Where(x => x.HeaderId == headerId).AsNoTracking().FirstOrDefault();
            }
        ...
        /// <summary>
        /// Get a EF6.InvtBatchADJ_Header object from the database using the given QueryString
        /// </summary>
        /// <param name="headerId">The primary key value</param>
        /// <returns>A EF6.InvtBatchADJ_Header object</returns>
        public static EF6.InvtBatchADJ_Header Get(string whereClause)
        {
            EF6.InvtBatchADJ_Header result = null;

            using (var ctx = new EF6.RT2020Entities())
            {
                result = ctx.InvtBatchADJ_Header
                    .SqlQuery(string.Format("Select * from InvtBatchADJ_Header Where {0}", whereClause))
                    .AsNoTracking()
                    .FirstOrDefault();
            }
        ...
        /// <summary>
        /// Get a list of InvtBatchADJ_Header objects from the database
        /// </summary>
        /// <returns>A list containing all of the InvtBatchADJ_Header objects in the database.</returns>
        public static List<EF6.InvtBatchADJ_Header> GetList()
        {
            var whereClause = "1 = 1";
        ...
        /// </summary>
        /// <returns>A list containing all of the InvtBatchADJ_Header objects in the database ordered by the columns specified.</returns>
        public static List<EF6.InvtBatchADJ_Header> GetList(string whereClause)
        {
        ...
        /// </summary>
        /// <returns>A list containing all of the InvtBatchADJ_Header objects in the database.</returns>
        public static List<EF6.InvtBatchADJ_Header> GetList(string whereClause, string[] orderBy)
        {
            List<EF6.InvtBatchADJ_Header> result = new List<EF6.InvtBatchADJ_Header>();
            ...
            {
                result = ctx.InvtBatchADJ_Header
                    .SqlQuery(string.Format("Select * from InvtBatchADJ_Header Where {0} Order By {1}", whereClause, orderby))
                    .AsNoTracking()
                    .ToList();
            }
		...
		public static void LoadCombo(ref ComboBox ddList, string TextField, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
        {
            ...
            using (var ctx = new EF6.RT2020Entities())
            {
                var list = ctx.InvtBatchADJ_Header.SqlQuery(
                    String.Format(
                        "Select * from InvtBatchADJ_Header Where {0} Order By {1}",
                ...
                if (BlankLine)
                {
                    list.Insert(0, new EF6.InvtBatchADJ_Header()
                    {
                        HeaderId = Guid.Empty,
                        TxType = "",
        ...
        private static string GetFormatedText(EF6.InvtBatchADJ_Header target, string[] textField, string textFormatString)
        {
            for (int i = 0; i < textField.Length; i++)
            {
