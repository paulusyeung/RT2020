...
";
        private static string _ReportFile = "Inventory\\Journal\\SA1330-Monthly.frx";           // FastReport
        private static string _ExcelTemplate = "Inventory\\Journal\\SA1330-Monthly.xlsx";       // ClosedXML.Report
        private static string _PivotTemplate = "Inventory\\Journal\\SA1330-MonthlyPivot.xlsx";  // ClosedXML.Report with Pivot
        ...
        /// <summary>
        /// 用 FastReport return the report in PDF byte array
        /// </summary>
        /// <param name="fromCode"></param>
        /// <param name="toCode"></param>
        /// <param name="fromDate"></param>
