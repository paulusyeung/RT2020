 ...
 *      
 *          Modified to use wwDbResourceDataManager and to
...
namespace Westwind.Globalization
{
    ...
    /// </remarks>
    public sealed class wwDbDesignTimeResourceProviderFactory : DesignTimeResourceProviderFactory
    {
        private IResourceProvider _localResourceProvider;
        
        public wwDbDesignTimeResourceProviderFactory()
        {
        }
        ...
        public override IResourceProvider CreateDesignTimeLocalResourceProvider(IServiceProvider serviceProvider)
        {
            ...
            {
                _localResourceProvider = new wwDbDesignTimeLocalResourceProvider(serviceProvider);
            }
        ...
        public override IDesignTimeResourceWriter CreateDesignTimeLocalResourceWriter(IServiceProvider serviceProvider)
        {
            ...
            return new wwDbDesignTimeLocalResourceProvider(serviceProvider);
        }
        ...
        /// </remarks>
        private sealed class wwDbDesignTimeLocalResourceProvider : IResourceProvider, IDesignTimeResourceWriter
        {
            ...
            public wwDbDesignTimeLocalResourceProvider(IServiceProvider serviceProvider)
            {
                // *** Have to force the configuration to read Web.Config settings explicitly at design time.
                if (string.IsNullOrEmpty(wwDbResourceConfiguration.Current.ConnectionString))
                    wwDbResourceConfiguration.Current.ReadDesignTimeConfiguration(serviceProvider);
            ...
            private string GetFullPagePath()
            {
                ...
                //string BasePath = wwDbResourceConfiguration.Current.DesignTimeVirtualPath;
                //if (BasePath == null)
                //    BasePath = "";
        ...
        private sealed class ResourceDictionary : IResourceDictionary
        {
            ...
            string IResourceDictionary.CreateResourceKey(object obj)
            {
                ...
                if (wwDbResourceConfiguration.Current.UseVsNetResourceNaming)
