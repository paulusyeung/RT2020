...
{
    /// <summary>
    /// This Data Access Layer Component (DALC) provides access to the data contained in the data table dbo.PosLedgerTender.
    /// Date Created:   2020-08-09 02:14:13
    /// Created By:     Generated by CodeSmith version 7.0.0.15123
    /// Template:       BusinessObjects_v5.0.cst
    /// </summary>
    public class PosLedgerTender
    {
        ...
        /// <summary>
        /// Initialize an new empty PosLedgerTender object.
        /// </summary>
        public PosLedgerTender()
        {
        }
		
        /// <summary>
        /// Initialize a new PosLedgerTender object with the given parameters.
        /// </summary>
        public PosLedgerTender(Guid tenderId, Guid headerId, string txType, string txNumber, DateTime txDate, Guid typeId, string currencyCode, string cardNumber, string authorizationCode, decimal tenderAmount, decimal exchangeRate, decimal inLocalCurrency, string eCR_TRACENUM, string eCR_RESPONSE)
        {
        ...
        /// <summary>
        /// Loads a PosLedgerTender object from the database using the given TenderId
        /// </summary>
        /// <param name="tenderId">The primary key value</param>
        /// <returns>A PosLedgerTender object</returns>
        public static PosLedgerTender Load(Guid tenderId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@TenderId", tenderId) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spPosLedgerTender_SelRec", parameterValues))
            {
                if (reader.Read())
                {
                    PosLedgerTender result = new PosLedgerTender();
        ...
        /// <summary>
        /// Loads a PosLedgerTender object from the database using the given where clause
        /// </summary>
        /// <param name="whereClause">The filter expression for the query</param>
        /// <returns>A PosLedgerTender object</returns>
        public static PosLedgerTender LoadWhere(string whereClause)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@WhereClause", whereClause) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spPosLedgerTender_SelAll", parameterValues))
            {
                if (reader.Read())
                {
                    PosLedgerTender result = new PosLedgerTender();
        ...
        /// <summary>
        /// Loads a collection of PosLedgerTender objects from the database.
        /// </summary>
        /// <returns>A collection containing all of the PosLedgerTender objects in the database.</returns>
        public static PosLedgerTenderCollection LoadCollection()
        {
            SqlParameter[] parms = new SqlParameter[] {};
            return LoadCollection("spPosLedgerTender_SelAll", parms);
        }

        /// <summary>
        /// Loads a collection of PosLedgerTender objects from the database ordered by the columns specified.
        /// </summary>
        /// <returns>A collection containing all of the PosLedgerTender objects in the database ordered by the columns specified.</returns>
        public static PosLedgerTenderCollection LoadCollection(string[] orderByColumns, bool ascending)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the PosLedgerTender objects in the database.</returns>
        public static PosLedgerTenderCollection LoadCollection(string whereClause)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the PosLedgerTender objects in the database ordered by the columns specified.</returns>
        public static PosLedgerTenderCollection LoadCollection(string whereClause, string[] orderByColumns, bool ascending)
        {
            StringBuilder orderClause = new StringBuilder();
            for (int i = 0; i < orderByColumns.Length; i++)
            {
        ...
        /// </summary>
        /// <returns>A collection containing all of the PosLedgerTender objects in the database.</returns>
        public static PosLedgerTenderCollection LoadCollection(string spName, SqlParameter[] parms)
        {
            PosLedgerTenderCollection result = new PosLedgerTenderCollection();
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader(spName, parms))
            {
                while (reader.Read())
                {
                    PosLedgerTender tmp = new PosLedgerTender();
        ...
        /// <summary>
        /// Deletes a PosLedgerTender object from the database.
        /// </summary>
        /// <param name="tenderId">The primary key value</param>
        public static void Delete(Guid tenderId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@TenderId", tenderId) };
            SqlHelper.Default.ExecuteNonQuery("spPosLedgerTender_DelRec", parameterValues);
        }
        ...
        private void Insert()
        {
            ...
            SqlHelper.Default.ExecuteNonQuery("spPosLedgerTender_InsRec", "@TenderId", out returnedValue, parameterValues);
        ...
        private void Update()
        {
			...
			SqlHelper.Default.ExecuteNonQuery("spPosLedgerTender_UpdRec", parameterValues);
        }
		...
		public static void LoadCombo(ref ComboBox ddList, string [] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
		{
			...
			PosLedgerTenderCollection source;
			...
			{
				source = PosLedgerTender.LoadCollection(WhereClause, OrderBy, true);
			}
			else
			{
				source = PosLedgerTender.LoadCollection(OrderBy, true);
			}
			...
			foreach (PosLedgerTender item in source)
			{
				bool filter = false;
		...
		private static bool IgnorThis(PosLedgerTender target, string parentFilter)
		{
			bool result = true;
			...
			{
				PosLedgerTender parentTemplate = PosLedgerTender.Load(target.HeaderId);
				result = IgnorThis(parentTemplate, parentFilter);
			}
			return result;
		}

		private static string GetFormatedText(PosLedgerTender target, string [] textField, string textFormatString)
		{
    ...
    /// <summary>
    /// Represents a collection of <see cref="PosLedgerTender">PosLedgerTender</see> objects.
    /// </summary>
    public class PosLedgerTenderCollection : BindingList< PosLedgerTender>
    {
	}
}
