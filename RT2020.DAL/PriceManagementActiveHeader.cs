...
{
    /// <summary>
    /// This Data Access Layer Component (DALC) provides access to the data contained in the data table dbo.PriceManagementActiveHeader.
    /// Date Created:   2020-08-09 02:14:13
    /// Created By:     Generated by CodeSmith version 7.0.0.15123
    /// Template:       BusinessObjects_v5.0.cst
    /// </summary>
    public class PriceManagementActiveHeader
    {
        ...
        /// <summary>
        /// Initialize an new empty PriceManagementActiveHeader object.
        /// </summary>
        ...
        /// <summary>
        /// Loads a PriceManagementActiveHeader object from the database using the given HeaderId
        /// </summary>
        /// <param name="headerId">The primary key value</param>
        /// <returns>A PriceManagementActiveHeader object</returns>
        public static PriceManagementActiveHeader Load(Guid headerId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@HeaderId", headerId) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spPriceManagementActiveHeader_SelRec", parameterValues))
            {
                if (reader.Read())
                {
                    PriceManagementActiveHeader result = new PriceManagementActiveHeader();
        ...
        /// <summary>
        /// Loads a PriceManagementActiveHeader object from the database using the given where clause
        /// </summary>
        /// <param name="whereClause">The filter expression for the query</param>
        /// <returns>A PriceManagementActiveHeader object</returns>
        public static PriceManagementActiveHeader LoadWhere(string whereClause)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@WhereClause", whereClause) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spPriceManagementActiveHeader_SelAll", parameterValues))
            {
                if (reader.Read())
                {
                    PriceManagementActiveHeader result = new PriceManagementActiveHeader();
        ...
        /// <summary>
        /// Loads a collection of PriceManagementActiveHeader objects from the database.
        /// </summary>
        /// <returns>A collection containing all of the PriceManagementActiveHeader objects in the database.</returns>
        public static PriceManagementActiveHeaderCollection LoadCollection()
        {
            SqlParameter[] parms = new SqlParameter[] {};
            return LoadCollection("spPriceManagementActiveHeader_SelAll", parms);
        }

        /// <summary>
        /// Loads a collection of PriceManagementActiveHeader objects from the database ordered by the columns specified.
        /// </summary>
        /// <returns>A collection containing all of the PriceManagementActiveHeader objects in the database ordered by the columns specified.</returns>
        public static PriceManagementActiveHeaderCollection LoadCollection(string[] orderByColumns, bool ascending)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the PriceManagementActiveHeader objects in the database.</returns>
        public static PriceManagementActiveHeaderCollection LoadCollection(string whereClause)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the PriceManagementActiveHeader objects in the database ordered by the columns specified.</returns>
        public static PriceManagementActiveHeaderCollection LoadCollection(string whereClause, string[] orderByColumns, bool ascending)
        {
            StringBuilder orderClause = new StringBuilder();
            for (int i = 0; i < orderByColumns.Length; i++)
            {
        ...
        /// </summary>
        /// <returns>A collection containing all of the PriceManagementActiveHeader objects in the database.</returns>
        public static PriceManagementActiveHeaderCollection LoadCollection(string spName, SqlParameter[] parms)
        {
            PriceManagementActiveHeaderCollection result = new PriceManagementActiveHeaderCollection();
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader(spName, parms))
            {
                while (reader.Read())
                {
                    PriceManagementActiveHeader tmp = new PriceManagementActiveHeader();
        ...
        /// <summary>
        /// Deletes a PriceManagementActiveHeader object from the database.
        /// </summary>
        /// <param name="headerId">The primary key value</param>
        public static void Delete(Guid headerId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@HeaderId", headerId) };
            SqlHelper.Default.ExecuteNonQuery("spPriceManagementActiveHeader_DelRec", parameterValues);
        }
        ...
        private void Insert()
        {
            ...
            SqlHelper.Default.ExecuteNonQuery("spPriceManagementActiveHeader_InsRec", "@HeaderId", out returnedValue, parameterValues);
        ...
        private void Update()
        {
			...
			SqlHelper.Default.ExecuteNonQuery("spPriceManagementActiveHeader_UpdRec", parameterValues);
        }
		...
		public static void LoadCombo(ref ComboBox ddList, string [] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
		{
			...
			PriceManagementActiveHeaderCollection source;
			...
			{
				source = PriceManagementActiveHeader.LoadCollection(WhereClause, OrderBy, true);
			}
			else
			{
				source = PriceManagementActiveHeader.LoadCollection(OrderBy, true);
			}
			...
			foreach (PriceManagementActiveHeader item in source)
			{
				bool filter = false;
		...
		private static bool IgnorThis(PriceManagementActiveHeader target, string parentFilter)
		{
			bool result = true;
			...
			{
				PriceManagementActiveHeader parentTemplate = PriceManagementActiveHeader.Load(target.ReasonId);
				result = IgnorThis(parentTemplate, parentFilter);
			}
			return result;
		}

		private static string GetFormatedText(PriceManagementActiveHeader target, string [] textField, string textFormatString)
		{
    ...
    /// <summary>
    /// Represents a collection of <see cref="PriceManagementActiveHeader">PriceManagementActiveHeader</see> objects.
    /// </summary>
    public class PriceManagementActiveHeaderCollection : BindingList< PriceManagementActiveHeader>
    {
	}
}
