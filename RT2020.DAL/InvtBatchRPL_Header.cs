...
{
    /// <summary>
    /// This Data Access Layer Component (DALC) provides access to the data contained in the data table dbo.InvtBatchRPL_Header.
    /// Date Created:   2020-08-09 02:14:10
    /// Created By:     Generated by CodeSmith version 7.0.0.15123
    /// Template:       BusinessObjects_v5.0.cst
    /// </summary>
    public class InvtBatchRPL_Header
    {
        ...
        /// <summary>
        /// Loads a InvtBatchRPL_Header object from the database using the given HeaderId
        /// </summary>
        /// <param name="headerId">The primary key value</param>
        /// <returns>A InvtBatchRPL_Header object</returns>
        public static InvtBatchRPL_Header Load(Guid headerId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@HeaderId", headerId) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spInvtBatchRPL_Header_SelRec", parameterValues))
            {
                if (reader.Read())
                {
                    InvtBatchRPL_Header result = new InvtBatchRPL_Header();
        ...
        /// <summary>
        /// Loads a InvtBatchRPL_Header object from the database using the given where clause
        /// </summary>
        /// <param name="whereClause">The filter expression for the query</param>
        /// <returns>A InvtBatchRPL_Header object</returns>
        public static InvtBatchRPL_Header LoadWhere(string whereClause)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@WhereClause", whereClause) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spInvtBatchRPL_Header_SelAll", parameterValues))
            {
                if (reader.Read())
                {
                    InvtBatchRPL_Header result = new InvtBatchRPL_Header();
        ...
        /// <summary>
        /// Loads a collection of InvtBatchRPL_Header objects from the database.
        /// </summary>
        /// <returns>A collection containing all of the InvtBatchRPL_Header objects in the database.</returns>
        public static InvtBatchRPL_HeaderCollection LoadCollection()
        {
            SqlParameter[] parms = new SqlParameter[] {};
            return LoadCollection("spInvtBatchRPL_Header_SelAll", parms);
        }

        /// <summary>
        /// Loads a collection of InvtBatchRPL_Header objects from the database ordered by the columns specified.
        /// </summary>
        /// <returns>A collection containing all of the InvtBatchRPL_Header objects in the database ordered by the columns specified.</returns>
        public static InvtBatchRPL_HeaderCollection LoadCollection(string[] orderByColumns, bool ascending)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the InvtBatchRPL_Header objects in the database.</returns>
        public static InvtBatchRPL_HeaderCollection LoadCollection(string whereClause)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the InvtBatchRPL_Header objects in the database ordered by the columns specified.</returns>
        public static InvtBatchRPL_HeaderCollection LoadCollection(string whereClause, string[] orderByColumns, bool ascending)
        {
            StringBuilder orderClause = new StringBuilder();
            for (int i = 0; i < orderByColumns.Length; i++)
            {
        ...
        /// </summary>
        /// <returns>A collection containing all of the InvtBatchRPL_Header objects in the database.</returns>
        public static InvtBatchRPL_HeaderCollection LoadCollection(string spName, SqlParameter[] parms)
        {
            InvtBatchRPL_HeaderCollection result = new InvtBatchRPL_HeaderCollection();
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader(spName, parms))
            {
                while (reader.Read())
                {
                    InvtBatchRPL_Header tmp = new InvtBatchRPL_Header();
        ...
        /// <summary>
        /// Deletes a InvtBatchRPL_Header object from the database.
        /// </summary>
        /// <param name="headerId">The primary key value</param>
        public static void Delete(Guid headerId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@HeaderId", headerId) };
            SqlHelper.Default.ExecuteNonQuery("spInvtBatchRPL_Header_DelRec", parameterValues);
        }
        ...
        private void Insert()
        {
            ...
            SqlHelper.Default.ExecuteNonQuery("spInvtBatchRPL_Header_InsRec", "@HeaderId", out returnedValue, parameterValues);
        ...
        private void Update()
        {
			...
			SqlHelper.Default.ExecuteNonQuery("spInvtBatchRPL_Header_UpdRec", parameterValues);
        }
		...
		public static void LoadCombo(ref ComboBox ddList, string [] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
		{
			...
			InvtBatchRPL_HeaderCollection source;
			...
			if (WhereClause.Length > 0)
			{
				source = InvtBatchRPL_Header.LoadCollection(WhereClause, OrderBy, true);
			}
			else
			{
				source = InvtBatchRPL_Header.LoadCollection(OrderBy, true);
			}
			...
			foreach (InvtBatchRPL_Header item in source)
			{
				bool filter = false;
		...
		private static bool IgnorThis(InvtBatchRPL_Header target, string parentFilter)
		{
			bool result = true;
			...
			{
				InvtBatchRPL_Header parentTemplate = InvtBatchRPL_Header.Load(target.StaffId);
				result = IgnorThis(parentTemplate, parentFilter);
			}
			return result;
		}

		private static string GetFormatedText(InvtBatchRPL_Header target, string [] textField, string textFormatString)
		{
    ...
    /// <summary>
    /// Represents a collection of <see cref="InvtBatchRPL_Header">InvtBatchRPL_Header</see> objects.
    /// </summary>
    public class InvtBatchRPL_HeaderCollection : BindingList< InvtBatchRPL_Header>
    {
	}
}
