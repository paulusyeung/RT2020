...
{
    /// <summary>
    /// This Data Access Layer Component (DALC) provides access to the data contained in the data table dbo.InvtSubLedgerREC_Details.
    /// Date Created:   2020-08-09 02:14:11
    /// Created By:     Generated by CodeSmith version 7.0.0.15123
    /// Template:       BusinessObjects_v5.0.cst
    /// </summary>
    public class InvtSubLedgerREC_Details
    {
        ...
        /// <summary>
        /// Initialize an new empty InvtSubLedgerREC_Details object.
        /// </summary>
        public InvtSubLedgerREC_Details()
        {
        }
		
        /// <summary>
        /// Initialize a new InvtSubLedgerREC_Details object with the given parameters.
        /// </summary>
        public InvtSubLedgerREC_Details(Guid detailsId, Guid headerId, string txType, string txNumber, int lineNumber, Guid productId, decimal qtyOrdered, decimal qtyReceived, decimal qtyReceivedSum, decimal unitCost, decimal discount, decimal netCost, string remarks, decimal nETRATECOST, decimal cOEFCOST, decimal bILLQTY, decimal bILLUAMT)
        {
        ...
        /// <summary>
        /// Loads a InvtSubLedgerREC_Details object from the database using the given DetailsId
        /// </summary>
        /// <param name="detailsId">The primary key value</param>
        /// <returns>A InvtSubLedgerREC_Details object</returns>
        public static InvtSubLedgerREC_Details Load(Guid detailsId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@DetailsId", detailsId) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spInvtSubLedgerREC_Details_SelRec", parameterValues))
            {
                if (reader.Read())
                {
                    InvtSubLedgerREC_Details result = new InvtSubLedgerREC_Details();
        ...
        /// <summary>
        /// Loads a InvtSubLedgerREC_Details object from the database using the given where clause
        /// </summary>
        /// <param name="whereClause">The filter expression for the query</param>
        /// <returns>A InvtSubLedgerREC_Details object</returns>
        public static InvtSubLedgerREC_Details LoadWhere(string whereClause)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@WhereClause", whereClause) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spInvtSubLedgerREC_Details_SelAll", parameterValues))
            {
                if (reader.Read())
                {
                    InvtSubLedgerREC_Details result = new InvtSubLedgerREC_Details();
        ...
        /// <summary>
        /// Loads a collection of InvtSubLedgerREC_Details objects from the database.
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerREC_Details objects in the database.</returns>
        public static InvtSubLedgerREC_DetailsCollection LoadCollection()
        {
            SqlParameter[] parms = new SqlParameter[] {};
            return LoadCollection("spInvtSubLedgerREC_Details_SelAll", parms);
        }

        /// <summary>
        /// Loads a collection of InvtSubLedgerREC_Details objects from the database ordered by the columns specified.
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerREC_Details objects in the database ordered by the columns specified.</returns>
        public static InvtSubLedgerREC_DetailsCollection LoadCollection(string[] orderByColumns, bool ascending)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerREC_Details objects in the database.</returns>
        public static InvtSubLedgerREC_DetailsCollection LoadCollection(string whereClause)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerREC_Details objects in the database ordered by the columns specified.</returns>
        public static InvtSubLedgerREC_DetailsCollection LoadCollection(string whereClause, string[] orderByColumns, bool ascending)
        {
            StringBuilder orderClause = new StringBuilder();
            for (int i = 0; i < orderByColumns.Length; i++)
            {
        ...
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerREC_Details objects in the database.</returns>
        public static InvtSubLedgerREC_DetailsCollection LoadCollection(string spName, SqlParameter[] parms)
        {
            InvtSubLedgerREC_DetailsCollection result = new InvtSubLedgerREC_DetailsCollection();
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader(spName, parms))
            {
                while (reader.Read())
                {
                    InvtSubLedgerREC_Details tmp = new InvtSubLedgerREC_Details();
        ...
        /// <summary>
        /// Deletes a InvtSubLedgerREC_Details object from the database.
        /// </summary>
        /// <param name="detailsId">The primary key value</param>
        public static void Delete(Guid detailsId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@DetailsId", detailsId) };
            SqlHelper.Default.ExecuteNonQuery("spInvtSubLedgerREC_Details_DelRec", parameterValues);
        }
        ...
        private void Insert()
        {
            ...
            SqlHelper.Default.ExecuteNonQuery("spInvtSubLedgerREC_Details_InsRec", "@DetailsId", out returnedValue, parameterValues);
        ...
        private void Update()
        {
			...
			SqlHelper.Default.ExecuteNonQuery("spInvtSubLedgerREC_Details_UpdRec", parameterValues);
        }
		...
		public static void LoadCombo(ref ComboBox ddList, string [] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
		{
			...
			InvtSubLedgerREC_DetailsCollection source;
			...
			{
				source = InvtSubLedgerREC_Details.LoadCollection(WhereClause, OrderBy, true);
			}
			else
			{
				source = InvtSubLedgerREC_Details.LoadCollection(OrderBy, true);
			}
			...
			foreach (InvtSubLedgerREC_Details item in source)
			{
				bool filter = false;
		...
		private static bool IgnorThis(InvtSubLedgerREC_Details target, string parentFilter)
		{
			bool result = true;
			...
			{
				InvtSubLedgerREC_Details parentTemplate = InvtSubLedgerREC_Details.Load(target.HeaderId);
				result = IgnorThis(parentTemplate, parentFilter);
			}
			return result;
		}

		private static string GetFormatedText(InvtSubLedgerREC_Details target, string [] textField, string textFormatString)
		{
    ...
    /// <summary>
    /// Represents a collection of <see cref="InvtSubLedgerREC_Details">InvtSubLedgerREC_Details</see> objects.
    /// </summary>
    public class InvtSubLedgerREC_DetailsCollection : BindingList< InvtSubLedgerREC_Details>
    {
	}
}
