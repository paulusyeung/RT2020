...
{
    /// <summary>
    /// This Data Access Layer Component (DALC) provides access to the data contained in the data table dbo.InvtSubLedgerADJ_Header.
    /// Date Created:   2020-08-09 02:14:11
    /// Created By:     Generated by CodeSmith version 7.0.0.15123
    /// Template:       BusinessObjects_v5.0.cst
    /// </summary>
    public class InvtSubLedgerADJ_Header
    {
        ...
        /// <summary>
        /// Initialize an new empty InvtSubLedgerADJ_Header object.
        /// </summary>
        public InvtSubLedgerADJ_Header()
        {
        }
		
        /// <summary>
        /// Initialize a new InvtSubLedgerADJ_Header object with the given parameters.
        /// </summary>
        public InvtSubLedgerADJ_Header(Guid headerId, string txType, string txNumber, DateTime txDate, Guid workplaceId, string reference, decimal totalAmount, string remarks, Guid staffId, DateTime postedOn, Guid postedBy, string tRF_REASON, int status, DateTime createdOn, Guid createdBy, DateTime modifiedOn, Guid modifiedBy, bool retired, DateTime retiredOn, Guid retiredBy)
        {
        ...
        /// <summary>
        /// Loads a InvtSubLedgerADJ_Header object from the database using the given HeaderId
        /// </summary>
        /// <param name="headerId">The primary key value</param>
        /// <returns>A InvtSubLedgerADJ_Header object</returns>
        public static InvtSubLedgerADJ_Header Load(Guid headerId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@HeaderId", headerId) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spInvtSubLedgerADJ_Header_SelRec", parameterValues))
            {
                if (reader.Read())
                {
                    InvtSubLedgerADJ_Header result = new InvtSubLedgerADJ_Header();
        ...
        /// <summary>
        /// Loads a InvtSubLedgerADJ_Header object from the database using the given where clause
        /// </summary>
        /// <param name="whereClause">The filter expression for the query</param>
        /// <returns>A InvtSubLedgerADJ_Header object</returns>
        public static InvtSubLedgerADJ_Header LoadWhere(string whereClause)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@WhereClause", whereClause) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spInvtSubLedgerADJ_Header_SelAll", parameterValues))
            {
                if (reader.Read())
                {
                    InvtSubLedgerADJ_Header result = new InvtSubLedgerADJ_Header();
        ...
        /// <summary>
        /// Loads a collection of InvtSubLedgerADJ_Header objects from the database.
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerADJ_Header objects in the database.</returns>
        public static InvtSubLedgerADJ_HeaderCollection LoadCollection()
        {
            SqlParameter[] parms = new SqlParameter[] {};
            return LoadCollection("spInvtSubLedgerADJ_Header_SelAll", parms);
        }

        /// <summary>
        /// Loads a collection of InvtSubLedgerADJ_Header objects from the database ordered by the columns specified.
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerADJ_Header objects in the database ordered by the columns specified.</returns>
        public static InvtSubLedgerADJ_HeaderCollection LoadCollection(string[] orderByColumns, bool ascending)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerADJ_Header objects in the database.</returns>
        public static InvtSubLedgerADJ_HeaderCollection LoadCollection(string whereClause)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerADJ_Header objects in the database ordered by the columns specified.</returns>
        public static InvtSubLedgerADJ_HeaderCollection LoadCollection(string whereClause, string[] orderByColumns, bool ascending)
        {
            StringBuilder orderClause = new StringBuilder();
            for (int i = 0; i < orderByColumns.Length; i++)
            {
        ...
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerADJ_Header objects in the database.</returns>
        public static InvtSubLedgerADJ_HeaderCollection LoadCollection(string spName, SqlParameter[] parms)
        {
            InvtSubLedgerADJ_HeaderCollection result = new InvtSubLedgerADJ_HeaderCollection();
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader(spName, parms))
            {
                while (reader.Read())
                {
                    InvtSubLedgerADJ_Header tmp = new InvtSubLedgerADJ_Header();
        ...
        /// <summary>
        /// Deletes a InvtSubLedgerADJ_Header object from the database.
        /// </summary>
        /// <param name="headerId">The primary key value</param>
        public static void Delete(Guid headerId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@HeaderId", headerId) };
            SqlHelper.Default.ExecuteNonQuery("spInvtSubLedgerADJ_Header_DelRec", parameterValues);
        }
        ...
        public void LoadFromReader(SqlDataReader reader)
        {
            if (reader != null && !reader.IsClosed)
            {
                ...
                if (!reader.IsDBNull(5)) reference = reader.GetString(5);
                if (!reader.IsDBNull(6)) totalAmount = reader.GetDecimal(6);
                if (!reader.IsDBNull(7)) remarks = reader.GetString(7);
                if (!reader.IsDBNull(8)) staffId = reader.GetGuid(8);
        ...
        private void Insert()
        {
            ...
            SqlHelper.Default.ExecuteNonQuery("spInvtSubLedgerADJ_Header_InsRec", "@HeaderId", out returnedValue, parameterValues);
        ...
        private void Update()
        {
			...
			SqlHelper.Default.ExecuteNonQuery("spInvtSubLedgerADJ_Header_UpdRec", parameterValues);
        }
        ...
        private SqlParameter[] GetInsertParameterValues()
        {
            ...
            prams[5] = GetSqlParameter("@Reference", ParameterDirection.Input, SqlDbType.VarChar, 12, this.Reference);
            prams[6] = GetSqlParameter("@TotalAmount", ParameterDirection.Input, SqlDbType.Money, 8, this.TotalAmount);
            prams[7] = GetSqlParameter("@Remarks", ParameterDirection.Input, SqlDbType.NVarChar, 512, this.Remarks);
            prams[8] = GetSqlParameter("@StaffId", ParameterDirection.Input, SqlDbType.UniqueIdentifier, 16, this.StaffId);
		...
		public static void LoadCombo(ref ComboBox ddList, string [] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
		{
			...
			InvtSubLedgerADJ_HeaderCollection source;
			...
			if (WhereClause.Length > 0)
			{
				source = InvtSubLedgerADJ_Header.LoadCollection(WhereClause, OrderBy, true);
			}
			else
			{
				source = InvtSubLedgerADJ_Header.LoadCollection(OrderBy, true);
			}
			...
			foreach (InvtSubLedgerADJ_Header item in source)
			{
				bool filter = false;
		...
		private static bool IgnorThis(InvtSubLedgerADJ_Header target, string parentFilter)
		{
			bool result = true;
			...
			{
				InvtSubLedgerADJ_Header parentTemplate = InvtSubLedgerADJ_Header.Load(target.WorkplaceId);
				result = IgnorThis(parentTemplate, parentFilter);
			}
			return result;
		}

		private static string GetFormatedText(InvtSubLedgerADJ_Header target, string [] textField, string textFormatString)
		{
    ...
    /// <summary>
    /// Represents a collection of <see cref="InvtSubLedgerADJ_Header">InvtSubLedgerADJ_Header</see> objects.
    /// </summary>
    public class InvtSubLedgerADJ_HeaderCollection : BindingList< InvtSubLedgerADJ_Header>
    {
	}
}
