...
{
    /// <summary>
    /// This Data Access Layer Component (DALC) provides access to the data contained in the data table dbo.EPOSSubLedgerHeader.
    /// Date Created:   2020-08-09 02:14:09
    /// Created By:     Generated by CodeSmith version 7.0.0.15123
    /// Template:       BusinessObjects_v5.0.cst
    /// </summary>
    public class EPOSSubLedgerHeader
    {
        ...
        /// <summary>
        /// Initialize an new empty EPOSSubLedgerHeader object.
        /// </summary>
        ...
        /// <summary>
        /// Loads a EPOSSubLedgerHeader object from the database using the given HeaderId
        /// </summary>
        /// <param name="headerId">The primary key value</param>
        /// <returns>A EPOSSubLedgerHeader object</returns>
        public static EPOSSubLedgerHeader Load(Guid headerId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@HeaderId", headerId) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spEPOSSubLedgerHeader_SelRec", parameterValues))
            {
                if (reader.Read())
                {
                    EPOSSubLedgerHeader result = new EPOSSubLedgerHeader();
        ...
        /// <summary>
        /// Loads a EPOSSubLedgerHeader object from the database using the given where clause
        /// </summary>
        /// <param name="whereClause">The filter expression for the query</param>
        /// <returns>A EPOSSubLedgerHeader object</returns>
        public static EPOSSubLedgerHeader LoadWhere(string whereClause)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@WhereClause", whereClause) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spEPOSSubLedgerHeader_SelAll", parameterValues))
            {
                if (reader.Read())
                {
                    EPOSSubLedgerHeader result = new EPOSSubLedgerHeader();
        ...
        /// <summary>
        /// Loads a collection of EPOSSubLedgerHeader objects from the database.
        /// </summary>
        /// <returns>A collection containing all of the EPOSSubLedgerHeader objects in the database.</returns>
        public static EPOSSubLedgerHeaderCollection LoadCollection()
        {
            SqlParameter[] parms = new SqlParameter[] {};
            return LoadCollection("spEPOSSubLedgerHeader_SelAll", parms);
        }

        /// <summary>
        /// Loads a collection of EPOSSubLedgerHeader objects from the database ordered by the columns specified.
        /// </summary>
        /// <returns>A collection containing all of the EPOSSubLedgerHeader objects in the database ordered by the columns specified.</returns>
        public static EPOSSubLedgerHeaderCollection LoadCollection(string[] orderByColumns, bool ascending)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the EPOSSubLedgerHeader objects in the database.</returns>
        public static EPOSSubLedgerHeaderCollection LoadCollection(string whereClause)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the EPOSSubLedgerHeader objects in the database ordered by the columns specified.</returns>
        public static EPOSSubLedgerHeaderCollection LoadCollection(string whereClause, string[] orderByColumns, bool ascending)
        {
            StringBuilder orderClause = new StringBuilder();
            for (int i = 0; i < orderByColumns.Length; i++)
            {
        ...
        /// </summary>
        /// <returns>A collection containing all of the EPOSSubLedgerHeader objects in the database.</returns>
        public static EPOSSubLedgerHeaderCollection LoadCollection(string spName, SqlParameter[] parms)
        {
            EPOSSubLedgerHeaderCollection result = new EPOSSubLedgerHeaderCollection();
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader(spName, parms))
            {
                while (reader.Read())
                {
                    EPOSSubLedgerHeader tmp = new EPOSSubLedgerHeader();
        ...
        /// <summary>
        /// Deletes a EPOSSubLedgerHeader object from the database.
        /// </summary>
        /// <param name="headerId">The primary key value</param>
        public static void Delete(Guid headerId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@HeaderId", headerId) };
            SqlHelper.Default.ExecuteNonQuery("spEPOSSubLedgerHeader_DelRec", parameterValues);
        }
        ...
        private void Insert()
        {
            ...
            SqlHelper.Default.ExecuteNonQuery("spEPOSSubLedgerHeader_InsRec", "@HeaderId", out returnedValue, parameterValues);
        ...
        private void Update()
        {
			...
			SqlHelper.Default.ExecuteNonQuery("spEPOSSubLedgerHeader_UpdRec", parameterValues);
        }
		...
		public static void LoadCombo(ref ComboBox ddList, string [] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
		{
			...
			EPOSSubLedgerHeaderCollection source;
			...
			{
				source = EPOSSubLedgerHeader.LoadCollection(WhereClause, OrderBy, true);
			}
			else
			{
				source = EPOSSubLedgerHeader.LoadCollection(OrderBy, true);
			}
			...
			foreach (EPOSSubLedgerHeader item in source)
			{
				bool filter = false;
		...
		private static bool IgnorThis(EPOSSubLedgerHeader target, string parentFilter)
		{
			bool result = true;
			...
			{
				EPOSSubLedgerHeader parentTemplate = EPOSSubLedgerHeader.Load(target.StaffId);
				result = IgnorThis(parentTemplate, parentFilter);
			}
			return result;
		}

		private static string GetFormatedText(EPOSSubLedgerHeader target, string [] textField, string textFormatString)
		{
    ...
    /// <summary>
    /// Represents a collection of <see cref="EPOSSubLedgerHeader">EPOSSubLedgerHeader</see> objects.
    /// </summary>
    public class EPOSSubLedgerHeaderCollection : BindingList< EPOSSubLedgerHeader>
    {
	}
}
