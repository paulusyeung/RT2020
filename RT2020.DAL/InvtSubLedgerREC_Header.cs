...
{
    /// <summary>
    /// This Data Access Layer Component (DALC) provides access to the data contained in the data table dbo.InvtSubLedgerREC_Header.
    /// Date Created:   2020-08-09 02:14:11
    /// Created By:     Generated by CodeSmith version 7.0.0.15123
    /// Template:       BusinessObjects_v5.0.cst
    /// </summary>
    public class InvtSubLedgerREC_Header
    {
        ...
        /// <summary>
        /// Loads a InvtSubLedgerREC_Header object from the database using the given HeaderId
        /// </summary>
        /// <param name="headerId">The primary key value</param>
        /// <returns>A InvtSubLedgerREC_Header object</returns>
        public static InvtSubLedgerREC_Header Load(Guid headerId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@HeaderId", headerId) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spInvtSubLedgerREC_Header_SelRec", parameterValues))
            {
                if (reader.Read())
                {
                    InvtSubLedgerREC_Header result = new InvtSubLedgerREC_Header();
        ...
        /// <summary>
        /// Loads a InvtSubLedgerREC_Header object from the database using the given where clause
        /// </summary>
        /// <param name="whereClause">The filter expression for the query</param>
        /// <returns>A InvtSubLedgerREC_Header object</returns>
        public static InvtSubLedgerREC_Header LoadWhere(string whereClause)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@WhereClause", whereClause) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spInvtSubLedgerREC_Header_SelAll", parameterValues))
            {
                if (reader.Read())
                {
                    InvtSubLedgerREC_Header result = new InvtSubLedgerREC_Header();
        ...
        /// <summary>
        /// Loads a collection of InvtSubLedgerREC_Header objects from the database.
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerREC_Header objects in the database.</returns>
        public static InvtSubLedgerREC_HeaderCollection LoadCollection()
        {
            SqlParameter[] parms = new SqlParameter[] {};
            return LoadCollection("spInvtSubLedgerREC_Header_SelAll", parms);
        }

        /// <summary>
        /// Loads a collection of InvtSubLedgerREC_Header objects from the database ordered by the columns specified.
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerREC_Header objects in the database ordered by the columns specified.</returns>
        public static InvtSubLedgerREC_HeaderCollection LoadCollection(string[] orderByColumns, bool ascending)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerREC_Header objects in the database.</returns>
        public static InvtSubLedgerREC_HeaderCollection LoadCollection(string whereClause)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerREC_Header objects in the database ordered by the columns specified.</returns>
        public static InvtSubLedgerREC_HeaderCollection LoadCollection(string whereClause, string[] orderByColumns, bool ascending)
        {
            StringBuilder orderClause = new StringBuilder();
            for (int i = 0; i < orderByColumns.Length; i++)
            {
        ...
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerREC_Header objects in the database.</returns>
        public static InvtSubLedgerREC_HeaderCollection LoadCollection(string spName, SqlParameter[] parms)
        {
            InvtSubLedgerREC_HeaderCollection result = new InvtSubLedgerREC_HeaderCollection();
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader(spName, parms))
            {
                while (reader.Read())
                {
                    InvtSubLedgerREC_Header tmp = new InvtSubLedgerREC_Header();
        ...
        /// <summary>
        /// Deletes a InvtSubLedgerREC_Header object from the database.
        /// </summary>
        /// <param name="headerId">The primary key value</param>
        public static void Delete(Guid headerId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@HeaderId", headerId) };
            SqlHelper.Default.ExecuteNonQuery("spInvtSubLedgerREC_Header_DelRec", parameterValues);
        }
        ...
        private void Insert()
        {
            ...
            SqlHelper.Default.ExecuteNonQuery("spInvtSubLedgerREC_Header_InsRec", "@HeaderId", out returnedValue, parameterValues);
        ...
        private void Update()
        {
			...
			SqlHelper.Default.ExecuteNonQuery("spInvtSubLedgerREC_Header_UpdRec", parameterValues);
        }
		...
		public static void LoadCombo(ref ComboBox ddList, string [] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
		{
			...
			InvtSubLedgerREC_HeaderCollection source;
			...
			if (WhereClause.Length > 0)
			{
				source = InvtSubLedgerREC_Header.LoadCollection(WhereClause, OrderBy, true);
			}
			else
			{
				source = InvtSubLedgerREC_Header.LoadCollection(OrderBy, true);
			}
			...
			foreach (InvtSubLedgerREC_Header item in source)
			{
				bool filter = false;
		...
		private static bool IgnorThis(InvtSubLedgerREC_Header target, string parentFilter)
		{
			bool result = true;
			...
			{
				InvtSubLedgerREC_Header parentTemplate = InvtSubLedgerREC_Header.Load(target.StaffId);
				result = IgnorThis(parentTemplate, parentFilter);
			}
			return result;
		}

		private static string GetFormatedText(InvtSubLedgerREC_Header target, string [] textField, string textFormatString)
		{
    ...
    /// <summary>
    /// Represents a collection of <see cref="InvtSubLedgerREC_Header">InvtSubLedgerREC_Header</see> objects.
    /// </summary>
    public class InvtSubLedgerREC_HeaderCollection : BindingList< InvtSubLedgerREC_Header>
    {
	}
}
