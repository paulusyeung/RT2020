...
{
    /// <summary>
    /// This Data Access Layer Component (DALC) provides access to the data contained in the data table dbo.EPOSSubLedgerTender.
    /// Date Created:   2020-08-09 02:14:09
    /// Created By:     Generated by CodeSmith version 7.0.0.15123
    /// Template:       BusinessObjects_v5.0.cst
    /// </summary>
    public class EPOSSubLedgerTender
    {
        ...
        /// <summary>
        /// Initialize an new empty EPOSSubLedgerTender object.
        /// </summary>
        public EPOSSubLedgerTender()
        {
        }
		
        /// <summary>
        /// Initialize a new EPOSSubLedgerTender object with the given parameters.
        /// </summary>
        public EPOSSubLedgerTender(Guid tenderId, Guid headerId, string txType, string txNumber, DateTime txDate, Guid typeId, string currencyCode, string cardNumber, string authorizationCode, decimal tenderAmount, decimal exchangeRate, decimal inLocalCurrency, string eCR_TRACENUM, string eCR_RESPONSE)
        {
        ...
        /// <summary>
        /// Loads a EPOSSubLedgerTender object from the database using the given TenderId
        /// </summary>
        /// <param name="tenderId">The primary key value</param>
        /// <returns>A EPOSSubLedgerTender object</returns>
        public static EPOSSubLedgerTender Load(Guid tenderId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@TenderId", tenderId) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spEPOSSubLedgerTender_SelRec", parameterValues))
            {
                if (reader.Read())
                {
                    EPOSSubLedgerTender result = new EPOSSubLedgerTender();
        ...
        /// <summary>
        /// Loads a EPOSSubLedgerTender object from the database using the given where clause
        /// </summary>
        /// <param name="whereClause">The filter expression for the query</param>
        /// <returns>A EPOSSubLedgerTender object</returns>
        public static EPOSSubLedgerTender LoadWhere(string whereClause)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@WhereClause", whereClause) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spEPOSSubLedgerTender_SelAll", parameterValues))
            {
                if (reader.Read())
                {
                    EPOSSubLedgerTender result = new EPOSSubLedgerTender();
        ...
        /// <summary>
        /// Loads a collection of EPOSSubLedgerTender objects from the database.
        /// </summary>
        /// <returns>A collection containing all of the EPOSSubLedgerTender objects in the database.</returns>
        public static EPOSSubLedgerTenderCollection LoadCollection()
        {
            SqlParameter[] parms = new SqlParameter[] {};
            return LoadCollection("spEPOSSubLedgerTender_SelAll", parms);
        }

        /// <summary>
        /// Loads a collection of EPOSSubLedgerTender objects from the database ordered by the columns specified.
        /// </summary>
        /// <returns>A collection containing all of the EPOSSubLedgerTender objects in the database ordered by the columns specified.</returns>
        public static EPOSSubLedgerTenderCollection LoadCollection(string[] orderByColumns, bool ascending)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the EPOSSubLedgerTender objects in the database.</returns>
        public static EPOSSubLedgerTenderCollection LoadCollection(string whereClause)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the EPOSSubLedgerTender objects in the database ordered by the columns specified.</returns>
        public static EPOSSubLedgerTenderCollection LoadCollection(string whereClause, string[] orderByColumns, bool ascending)
        {
            StringBuilder orderClause = new StringBuilder();
            for (int i = 0; i < orderByColumns.Length; i++)
            {
        ...
        /// </summary>
        /// <returns>A collection containing all of the EPOSSubLedgerTender objects in the database.</returns>
        public static EPOSSubLedgerTenderCollection LoadCollection(string spName, SqlParameter[] parms)
        {
            EPOSSubLedgerTenderCollection result = new EPOSSubLedgerTenderCollection();
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader(spName, parms))
            {
                while (reader.Read())
                {
                    EPOSSubLedgerTender tmp = new EPOSSubLedgerTender();
        ...
        /// <summary>
        /// Deletes a EPOSSubLedgerTender object from the database.
        /// </summary>
        /// <param name="tenderId">The primary key value</param>
        public static void Delete(Guid tenderId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@TenderId", tenderId) };
            SqlHelper.Default.ExecuteNonQuery("spEPOSSubLedgerTender_DelRec", parameterValues);
        }
        ...
        private void Insert()
        {
            ...
            SqlHelper.Default.ExecuteNonQuery("spEPOSSubLedgerTender_InsRec", "@TenderId", out returnedValue, parameterValues);
        ...
        private void Update()
        {
			...
			SqlHelper.Default.ExecuteNonQuery("spEPOSSubLedgerTender_UpdRec", parameterValues);
        }
		...
		public static void LoadCombo(ref ComboBox ddList, string [] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
		{
			...
			EPOSSubLedgerTenderCollection source;
			...
			{
				source = EPOSSubLedgerTender.LoadCollection(WhereClause, OrderBy, true);
			}
			else
			{
				source = EPOSSubLedgerTender.LoadCollection(OrderBy, true);
			}
			...
			foreach (EPOSSubLedgerTender item in source)
			{
				bool filter = false;
		...
		private static bool IgnorThis(EPOSSubLedgerTender target, string parentFilter)
		{
			bool result = true;
			...
			{
				EPOSSubLedgerTender parentTemplate = EPOSSubLedgerTender.Load(target.HeaderId);
				result = IgnorThis(parentTemplate, parentFilter);
			}
			return result;
		}

		private static string GetFormatedText(EPOSSubLedgerTender target, string [] textField, string textFormatString)
		{
    ...
    /// <summary>
    /// Represents a collection of <see cref="EPOSSubLedgerTender">EPOSSubLedgerTender</see> objects.
    /// </summary>
    public class EPOSSubLedgerTenderCollection : BindingList< EPOSSubLedgerTender>
    {
	}
}
