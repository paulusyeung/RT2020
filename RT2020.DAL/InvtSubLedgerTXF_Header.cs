...
{
    /// <summary>
    /// This Data Access Layer Component (DALC) provides access to the data contained in the data table dbo.InvtSubLedgerTXF_Header.
    /// Date Created:   2020-08-09 02:14:11
    /// Created By:     Generated by CodeSmith version 7.0.0.15123
    /// Template:       BusinessObjects_v5.0.cst
    /// </summary>
    public class InvtSubLedgerTXF_Header
    {
        ...
        /// <summary>
        /// Initialize an new empty InvtSubLedgerTXF_Header object.
        /// </summary>
        ...
        /// <summary>
        /// Loads a InvtSubLedgerTXF_Header object from the database using the given HeaderId
        /// </summary>
        /// <param name="headerId">The primary key value</param>
        /// <returns>A InvtSubLedgerTXF_Header object</returns>
        public static InvtSubLedgerTXF_Header Load(Guid headerId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@HeaderId", headerId) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spInvtSubLedgerTXF_Header_SelRec", parameterValues))
            {
                if (reader.Read())
                {
                    InvtSubLedgerTXF_Header result = new InvtSubLedgerTXF_Header();
        ...
        /// <summary>
        /// Loads a InvtSubLedgerTXF_Header object from the database using the given where clause
        /// </summary>
        /// <param name="whereClause">The filter expression for the query</param>
        /// <returns>A InvtSubLedgerTXF_Header object</returns>
        public static InvtSubLedgerTXF_Header LoadWhere(string whereClause)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@WhereClause", whereClause) };
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader("spInvtSubLedgerTXF_Header_SelAll", parameterValues))
            {
                if (reader.Read())
                {
                    InvtSubLedgerTXF_Header result = new InvtSubLedgerTXF_Header();
        ...
        /// <summary>
        /// Loads a collection of InvtSubLedgerTXF_Header objects from the database.
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerTXF_Header objects in the database.</returns>
        public static InvtSubLedgerTXF_HeaderCollection LoadCollection()
        {
            SqlParameter[] parms = new SqlParameter[] {};
            return LoadCollection("spInvtSubLedgerTXF_Header_SelAll", parms);
        }

        /// <summary>
        /// Loads a collection of InvtSubLedgerTXF_Header objects from the database ordered by the columns specified.
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerTXF_Header objects in the database ordered by the columns specified.</returns>
        public static InvtSubLedgerTXF_HeaderCollection LoadCollection(string[] orderByColumns, bool ascending)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerTXF_Header objects in the database.</returns>
        public static InvtSubLedgerTXF_HeaderCollection LoadCollection(string whereClause)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerTXF_Header objects in the database ordered by the columns specified.</returns>
        public static InvtSubLedgerTXF_HeaderCollection LoadCollection(string whereClause, string[] orderByColumns, bool ascending)
        {
            StringBuilder orderClause = new StringBuilder();
            for (int i = 0; i < orderByColumns.Length; i++)
            {
        ...
        /// </summary>
        /// <returns>A collection containing all of the InvtSubLedgerTXF_Header objects in the database.</returns>
        public static InvtSubLedgerTXF_HeaderCollection LoadCollection(string spName, SqlParameter[] parms)
        {
            InvtSubLedgerTXF_HeaderCollection result = new InvtSubLedgerTXF_HeaderCollection();
            using (SqlDataReader reader = SqlHelper.Default.ExecuteReader(spName, parms))
            {
                while (reader.Read())
                {
                    InvtSubLedgerTXF_Header tmp = new InvtSubLedgerTXF_Header();
        ...
        /// <summary>
        /// Deletes a InvtSubLedgerTXF_Header object from the database.
        /// </summary>
        /// <param name="headerId">The primary key value</param>
        public static void Delete(Guid headerId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@HeaderId", headerId) };
            SqlHelper.Default.ExecuteNonQuery("spInvtSubLedgerTXF_Header_DelRec", parameterValues);
        }
        ...
        private void Insert()
        {
            ...
            SqlHelper.Default.ExecuteNonQuery("spInvtSubLedgerTXF_Header_InsRec", "@HeaderId", out returnedValue, parameterValues);
        ...
        private void Update()
        {
			...
			SqlHelper.Default.ExecuteNonQuery("spInvtSubLedgerTXF_Header_UpdRec", parameterValues);
        }
        ...
        private SqlParameter[] GetInsertParameterValues()
        {
            ...
            prams[20] = GetSqlParameter("@TRF_TYPE", ParameterDirection.Input, SqlDbType.VarChar, 1, this.TRF_TYPE);
        ...
        private SqlParameter[] GetUpdateParameterValues()
        {
            return new SqlParameter[] 
            {
                ...
                GetSqlParameterWithoutDirection("@TRF_TYPE", SqlDbType.VarChar, 1, this.TRF_TYPE),
		...
		public static void LoadCombo(ref ComboBox ddList, string [] TextField, string TextFormatString, bool SwitchLocale, bool BlankLine, string BlankLineText, string ParentFilter, string WhereClause, string[] OrderBy)
		{
			...
			InvtSubLedgerTXF_HeaderCollection source;
			...
			if (WhereClause.Length > 0)
			{
				source = InvtSubLedgerTXF_Header.LoadCollection(WhereClause, OrderBy, true);
			}
			else
			{
				source = InvtSubLedgerTXF_Header.LoadCollection(OrderBy, true);
			}
			...
			foreach (InvtSubLedgerTXF_Header item in source)
			{
				bool filter = false;
		...
		private static bool IgnorThis(InvtSubLedgerTXF_Header target, string parentFilter)
		{
			bool result = true;
			...
			{
				InvtSubLedgerTXF_Header parentTemplate = InvtSubLedgerTXF_Header.Load(target.StaffId);
				result = IgnorThis(parentTemplate, parentFilter);
			}
			return result;
		}

		private static string GetFormatedText(InvtSubLedgerTXF_Header target, string [] textField, string textFormatString)
		{
    ...
    /// <summary>
    /// Represents a collection of <see cref="InvtSubLedgerTXF_Header">InvtSubLedgerTXF_Header</see> objects.
    /// </summary>
    public class InvtSubLedgerTXF_HeaderCollection : BindingList< InvtSubLedgerTXF_Header>
    {
	}
}
