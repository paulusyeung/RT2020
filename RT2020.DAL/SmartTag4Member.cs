...
{
    /// <summary>
    /// This Data Access Layer Component (DALC) provides access to the data contained in the data table dbo.SmartTag4Member.
    /// Date Created:   2020-08-09 02:14:15
    /// Created By:     Generated by CodeSmith version 7.0.0.15123
    /// Template:       BusinessObjects_v5.0.cst
    /// </summary>
    public class SmartTag4Member
    {
        ...
        /// <summary>
        /// Initialize an new empty SmartTag4Member object.
        /// </summary>
        ...
        /// <summary>
        /// Initialize a new SmartTag4Member object with the given parameters.
        /// </summary>
        public SmartTag4Member(Guid tagId, string tagCode, string tagName, string tagName_Chs, string tagName_Cht, int priority)
        {
                this.tagId = tagId;
        ...
        public static SmartTag4MemberCollection LoadCollection()
        {
            SqlParameter[] parms = new SqlParameter[] {};
            return LoadCollection("spSmartTag4Member_SelAll", parms);
        }

        /// <summary>
        /// Loads a collection of SmartTag4Member objects from the database ordered by the columns specified.
        /// </summary>
        /// <returns>A collection containing all of the SmartTag4Member objects in the database ordered by the columns specified.</returns>
        public static SmartTag4MemberCollection LoadCollection(string[] orderByColumns, bool ascending)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the SmartTag4Member objects in the database.</returns>
        public static SmartTag4MemberCollection LoadCollection(string whereClause)
        {
        ...
        /// </summary>
        /// <returns>A collection containing all of the SmartTag4Member objects in the database ordered by the columns specified.</returns>
        public static SmartTag4MemberCollection LoadCollection(string whereClause, string[] orderByColumns, bool ascending)
        {
            StringBuilder orderClause = new StringBuilder();
            for (int i = 0; i < orderByColumns.Length; i++)
            {
        ...
        /// <summary>
        /// Deletes a SmartTag4Member object from the database.
        /// </summary>
        /// <param name="tagId">The primary key value</param>
        public static void Delete(Guid tagId)
        {
            SqlParameter[] parameterValues = new SqlParameter[] { new SqlParameter("@TagId", tagId) };
            SqlHelper.Default.ExecuteNonQuery("spSmartTag4Member_DelRec", parameterValues);
        }
        ...
        private void Insert()
        {
            ...
            SqlHelper.Default.ExecuteNonQuery("spSmartTag4Member_InsRec", "@TagId", out returnedValue, parameterValues);
        ...
        private void Update()
        {
			...
			SqlHelper.Default.ExecuteNonQuery("spSmartTag4Member_UpdRec", parameterValues);
        }
    ...
    /// <summary>
    /// Represents a collection of <see cref="SmartTag4Member">SmartTag4Member</see> objects.
    /// </summary>
    public class SmartTag4MemberCollection : BindingList< SmartTag4Member>
    {
	}
}
